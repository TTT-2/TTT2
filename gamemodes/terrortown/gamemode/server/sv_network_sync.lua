...
-- @param table metadata? The metadata table
-- @realm server
...
-- @param Entity client? The client/entity to set this value for (overrides the default value)
-- @realm server
...
-- @param Entity client? The client/entity to get the value for
...
-- @param Entity client? The client/entity to set this value for (as an override for the default value)
-- @realm server
...
-- @param table path? The current path to the curTable based on the root of the data table
-- @realm server
...
-- @param Player|table client? The client/list of clients or nil to send this to all known clients
-- @realm server
...
--
-- @param Player|table client? The client/list of clients or nil for all known clients, to send the update to
-- @realm server
...
-- @param any val? The value to send, can also be nil
-- @realm server
...
-- @param number bits? The bits that this number needs to be stored (optional, otherwise a default of 32 is used)
-- @param Entity client? The client/entity to set this value for (as an override for the default value)
-- @realm server
...
--
-- @param any|table path The path to set the value for
-- @param number value? The unsigned number value to set
-- @param number bits? The bits that this number needs to be stored (optional, otherwise a default of 32 is used)
-- @param Entity client? The client/entity to set this value for (as an override for the default value)
-- @realm server
