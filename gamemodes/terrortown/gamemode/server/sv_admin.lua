...
CreateConVar("ttt_highlight_dev", "1", {FCVAR_NOTIFY, FCVAR_ARCHIVE})
CreateConVar("ttt_highlight_vip", "1", {FCVAR_NOTIFY, FCVAR_ARCHIVE})
...
cvars.AddChangeCallback("ttt_highlight_dev", function(cv, old, new)
	SetGlobalBool("ttt_highlight_dev", tobool(tonumber(new)))
end)
cvars.AddChangeCallback("ttt_highlight_vip", function(cv, old, new)
	SetGlobalBool("ttt_highlight_vip", tobool(tonumber(new)))
end)
cvars.AddChangeCallback("ttt_highlight_addondev", function(cv, old, new)
	SetGlobalBool("ttt_highlight_addondev", tobool(tonumber(new)))
end)
cvars.AddChangeCallback("ttt_highlight_supporter", function(cv, old, new)
	SetGlobalBool("ttt_highlight_supporter", tobool(tonumber(new)))
end)
