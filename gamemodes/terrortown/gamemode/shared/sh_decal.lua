...
if SERVER then
    ...
    -- @param Vector startpos The start of the trace
    -- @param Vector endpos The end of the trace
    -- @param Entity filter? If set, the decal will not be able to be placed on given entity. Warning: Must be a table on the server
    -- @param Entity playerlist? If set, it defines which player will see the decal; visible to all players if not set
    -- @realm server
    ...
    -- Removed one specific decal by its id
    -- @param string id The unique id of the decal that should be removed
    -- @param Entity playerlist? If set, it defines which player will see the decal removal; visible to all players if not set
    -- @realm server
...
-- @param Entity ignore? If set, the decal will not be able to be placed on given entity. Warning: Must be a table on the
