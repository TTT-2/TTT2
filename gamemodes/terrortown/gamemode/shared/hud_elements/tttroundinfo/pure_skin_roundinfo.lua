...
if CLIENT then
	...
	function HUDELEMENT:Draw()
		...
		if is_haste then
			draw.AdvancedText(L.hastemode, "PureSkinMSTACKMsg", tmpx, self.pos.y + self.pad, draw.GetDefaultColor(self.basecolor), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, true, self.scale)
		end
