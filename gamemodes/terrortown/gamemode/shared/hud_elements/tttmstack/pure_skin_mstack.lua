...
if CLIENT then
	...
	function HUDELEMENT:DrawSmallMessage(item, pos_y, alpha)
		...
		for i = 1, #item.text_wrapped do
			...
			util.DrawAdvancedText(text_spec.text, text_spec.font, text_spec.pos[1], text_spec.pos[2], text_spec.color, text_spec.xalign, text_spec.yalign, true, self.scale)
	...
	function HUDELEMENT:DrawMessageWithImage(item, pos_y, alpha)
		...
		for i = 1, #item.title_wrapped do
			...
			util.DrawAdvancedText(title_spec.text, title_spec.font, title_spec.pos[1], title_spec.pos[2], title_spec.color, title_spec.xalign, title_spec.yalign, true, self.scale)
