...
if CLIENT then
	...
	function HUDELEMENT:DrawBar(x, y, w, h, alpha, item)
		...
		--draw icon
		draw.FilteredShadowedTexture(x, y, h, h, icon, math.Round(alpha * 0.75), draw.GetDefaultColor(tipColor), self.scale)

		-- draw lines around the element
		self.drawer:DrawLines(x, y, w, h, alpha)

		--draw name text
		local fontColor = draw.GetDefaultColor(self.basecolor)
