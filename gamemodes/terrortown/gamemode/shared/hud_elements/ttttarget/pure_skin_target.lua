...
if CLIENT then -- CLIENT
	...
	function HUDELEMENT:DrawComponent(name)
		...
		util.DrawAdvancedText(name, "PureSkinBar", x + self.iconSize + self.pad, y + h * 0.5, self:GetDefaultFontColor(self.basecolor), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, true, self.scale)
