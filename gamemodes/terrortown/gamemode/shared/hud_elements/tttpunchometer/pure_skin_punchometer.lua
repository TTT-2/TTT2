...
if CLIENT then
	...
	function HUDELEMENT:GetDefaults()
		const_defaults["basepos"] = {x = ScrW() * 0.5 - self.size.w * 0.5, y = ScrH() - 120 * self.scale}
	...
	function HUDELEMENT:ShouldDraw()
		...
		return client:IsSpec() and IsValid(tgt) and not tgt:IsPlayer() and tgt:GetNWEntity("spec_owner", nil) == client
	end
