...
L.menu_gameplay_description = "Не становиться определёнными ролями и другие функции"
...
L.item_no_hazard_damage_desc = [[Делает вас неуязвимым к токсичности вроде яда, кислоты и радиации.]]
