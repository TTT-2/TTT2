...
L.menu_bindings_description = "Назначьте клавиши на различные функции TTT2 и его дополнений на своё усмотрение"
...
L.menu_addons_description = "Настройте дополнения сервера на своё усмотрение"
...
L.help_damage_indicator_desc = "Индикатор урона - наложение, которое показывается, когда игрок получает урон. Чтобы добавить новую тему, поместите png-файл в 'materials/vgui/ttt/damageindicator/themes/'."
...
L.label_hud_select = "Интерфейс"
L.label_vskin_select = "VSkin"
...
L.label_damage_indicator_mode = "Тема индикатора урона"
