...
L.reroll_no_credits = "Вам нужно {amount} кредит(а/ов), чтобы перемешать снаряжение!"
L.reroll_button = "Перемешать"
L.reroll_help = "Используйте {amount} кредит(а/ов), чтобы в вашем магазине появились новые предметы!"
...
L.menu_gameplay_description = "Настройки назначения ролей и других функций"
