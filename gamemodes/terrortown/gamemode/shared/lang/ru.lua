...
L.desc_event_kill_blowup = "{victim} взрывает самого себя."
L.desc_event_kill_blowup_trap = "{victim} взрывается от {trap}."

L.desc_event_kill_tele_self = "{victim} убивает себя телепортом."
L.desc_event_kill_sui = "{victim} не выдерживает и совершает самоубийство."
L.desc_event_kill_sui_using = "{victim} совершает самоубийство при помощи {tool}."

L.desc_event_kill_fall = "{victim} разбивается насмерть."
L.desc_event_kill_fall_pushed = "{victim} разбивается насмерть после толчка от {attacker}."
L.desc_event_kill_fall_pushed_using = "{victim} разбивается насмерть после толчка от {trap}, активированной {attacker}."

L.desc_event_kill_shot = "{victim} был застрелен {attacker}."
L.desc_event_kill_shot_using = "{victim} был застрелен {attacker} с помощью {weapon}."

L.desc_event_kill_drown = "{victim} был утоплен {attacker}."
L.desc_event_kill_drown_using = "{victim} был утоплен {trap}, активированной {attacker}."

L.desc_event_kill_boom = "{victim} был взорван {attacker}."
L.desc_event_kill_boom_using = "{victim} был взорван {attacker} при помощи {trap}."

L.desc_event_kill_burn = "{victim} был сожжён {attacker}."
L.desc_event_kill_burn_using = "{victim} был сожжён {trap} из-за {attacker}."

L.desc_event_kill_club = "{victim} был избит {attacker}."
L.desc_event_kill_club_using = "{{victim} был избит {attacker} при помощи {trap}"

L.desc_event_kill_slash = "{victim} был зарезан {attacker}."
L.desc_event_kill_slash_using = "{victim} был зарезан {attacker} при помощи {trap}."

L.desc_event_kill_tele = "{victim} был убит телепортацией {attacker}."
L.desc_event_kill_tele_using = "{victim} был распылён {trap}, установленной {attacker}."

L.desc_event_kill_goomba = "{victim} был раздавлен большой массой {attacker}."

L.desc_event_kill_crush = "{victim} был раздавлен {attacker}."
L.desc_event_kill_crush_using = "{victim} был раздавлен {attacker} при помощи {trap}."

L.desc_event_kill_other = "{victim} был убит {attacker}."
L.desc_event_kill_other_using = "{victim} был убит {attacker} при помощи {trap}."
