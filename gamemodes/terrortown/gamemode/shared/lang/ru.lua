...
L.help_hud_default_desc = "Установить интерфейс по умолчанию для всех игроков. У игроков, которые ещё не выбрали интерфейс, будет использоваться этот интерфейс. Эта настройка не изменит интерфейс тех, кто его уже выбрали."
...
L.label_blur_enable = "Включить размытие фона"
