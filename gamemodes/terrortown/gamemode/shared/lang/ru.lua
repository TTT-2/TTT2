...
L.label_damage_indicator_duration = "Сколько секунд будет показываться индикатор урона после получения урона"
L.label_damage_indicator_maxdamage = "Сколько урона необходимо для максимальной непрозрачности"
