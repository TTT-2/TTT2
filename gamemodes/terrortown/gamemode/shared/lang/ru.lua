...
Можно купить несколько раз. При достижении определённого уровня брони, она становится сильнее.]]
...
L.ev_win_traitors = "Подлые предатели победили!"
L.ev_win_innocents = "Милые невиновные террористы победили!"
...
L.reroll_no_credits = "Вам нужно {amount} кредитов, чтобы перемешать снаряжение!"
L.reroll_button = "Перемешать"
L.reroll_help = "Используйте {amount} кредитов, чтобы в вашем магазине появились новые предметы!"
...
L.pickup_pending = "Вы уже подобрали оружие, подождите, пока не получите его"

-- 2020-01-07
L.tbut_help_admin = "Изменить настройки предательской кнопки"
L.tbut_role_toggle = "[{walkkey} + {usekey}], чтобы включить/выключить эту кнопку для роли {role}"
L.tbut_role_config = "Роль: {current}"
L.tbut_team_toggle = "[SHIFT + {walkkey} + {usekey}], чтобы включить/выключить эту кнопку для команды {team}"
L.tbut_team_config = "Команда: {current}"
L.tbut_current_config = "Текущие настройки:"
L.tbut_intended_config = "Задуманные создателем карты настройки:"
L.tbut_admin_mode_only = "Видна вам потому, что вы - администратор, а '{cv}' выставлено на '1'"
...
L.door_locked = "Эта дверь закрыта"

-- 2020-02-11
L.automoved_to_spec = "(АВТОМАТИЧЕСКОЕ СООБЩЕНИЕ) Я был перемещён в команду наблюдателей, так как бездействовал длительное время."
L.mute_team = "{team} заглушена."
...
L.menu_addons_title = "Аддоны"
L.menu_legacy_title = "Старые аддоны"
...
L.menu_guide_description = "Поможет вам начать играть в TTT2 и объяснит некоторые вещи о игре, ролях и другом"
L.menu_bindings_description = "Назначьте клавиши на различные функции TTT2 и его аддонов на своё усмотрение"
L.menu_language_description = "Выберите язык игры"
L.menu_appearance_description = "Измените внешний вид интерфейса"
L.menu_gameplay_description = "Настройте определённые функции TTT2 под себя"
L.menu_addons_description = "Настройте аддоны сервера на своё усмотрение"
L.menu_legacy_description = "Панель с конвертированными вкладками из оригинального TTT, должны быть портированы на новую систему"
L.menu_administration_description = "Общие настройки интерфейсов, магазинов и т.д."
L.menu_equipment_description = "Настройте кредиты, ограничения, доступность и всё остальное"
L.menu_shops_description = "Добавьте/удалите магазины ролей и определите снаряжение в них"
...
L.submenu_appearance_hudswitcher_title = "Сменить интерфейс"
--L.submenu_appearance_vskin_title = "VSkin"
L.submenu_appearance_targetid_title = "Информация под прицелом"
...
L.submenu_gameplay_avoidroles_title = "Назначение ролей"

L.submenu_administration_hud_title = "Настройки интерфейса"
L.submenu_administration_random_shop = "Случайный магазин"

L.help_color_desc = "Если эта настройка включена, может быть выбран глобальный цвет, который будет использоваться для прицела и обводок."
L.help_scale_factor = "Глобальный масштаб влияет на все элементы интерфейса. Он автоматически обновляется при изменении разрешения экрана. Изменение этой настройки сбросит настройки интерфейса!"
L.help_hud_game_reload = "Интерфейс сейчас не доступен. Игру нужно перезагрузить."
L.help_hud_special_settings = "Специфические настройки этого интерфейса"
L.help_vskin_info = "VSkin (скин vgui) - применяемый ко всем элементам меню скин. Скины можно легко создать Lua-скриптом. Они могут изменять цвета и некоторые параметры размера."
L.help_targetid_info = "TargetID (информация под прицелом) - информация, отображаемая при наведении на предмет. Её цвет можно настроить во вкладке Общее."
L.help_hud_default_desc = "Установть интерфейс по умолчанию для всех игроков. У игроков, которые ещё не выбрали интерфейс, будет использоваться этот интерфейс. Эта настройка не изменит интерфейс тех, кто его уже выбрали."
L.help_hud_forced_desc = "Установить интерфейс для всех игроков. Отключает выбор интерфейса для всех."
L.help_hud_enabled_desc = "Включить/выключить интерфейсы, чтобы запретить их использование."
L.help_damage_indicator_desc = "Индикатор урона - оверлей, который показывается, когда игрок получает урон. Чтобы добавить новую тему, поместите png-файл в 'materials/vgui/ttt/damageindicator/themes/'."
...
L.label_menu_admin_spacer = "Администраторский участок (не показывается обычным пользователям)"
...
L.label_global_scale_factor = "Глобальный масштаб"
L.label_hud_select = "Выбрать интерфейс"
L.label_vskin_select = "Выбрать VSkin"
L.label_blur_enable = "Включить размытие фона VSkin"
L.label_color_enable = "Включить цвет фона VSkin"
...
L.label_shop_double_click_buy = "Покупка предметов в магазине двойным щелчком мыши"
...
L.label_damage_indicator_mode = "Выбрать тему индикатора урона"
L.label_damage_indicator_duration = "Продолжительность индикатора урона в секундах"
L.label_damage_indicator_maxdamage = "Необходимый урон для максимальной непрозрачности"
L.label_damage_indicator_maxalpha = "Максимальная непрозрачность индикатора урона"
L.label_performance_halo_enable = "Отображать контуры вокруг некоторых энтити при наведении прицела."
L.label_performance_spec_outline_enable = "Включить обводки контролируемых предметов"
L.label_performance_ohicon_enable = "Включить иконки ролей над игроками"
...
L.label_inferface_wswitch_hide_enable = "Включить авто-закрывание меню переключения оружия"
...
L.label_gameplay_hold_aim = "Включить удерживание для прицеливания"
L.label_gameplay_mute = "Заглушать живых игроков после смерти."
L.label_gameplay_dtsprint_enable = "Включить бег двойным нажатием"
L.label_gameplay_dtsprint_anykey = "Продолжать бегать после двойного нажатия до остановки движения"
...
L.header_global_color = "Выбрать глобальный цвет"
L.header_hud_select = "Выбрать интерфейс"
L.header_hud_customize = "Настроить интерфейс"
L.header_vskin_select = "Выбрать и настроить VSkin"
L.header_targetid = "Настройки TargetID"
...
L.item_no_hazard_damage = "Иммунитет к токсичности"
L.item_no_hazard_damage_desc = [[Делает вас неуязвимым к токсичным веществам вроде яда и кислоты, а также к радиации.]]
L.item_no_energy_damage = "Иммунитет к энергии"
L.item_no_energy_damage_desc = [[Делает вас неуязвимым к урону от энергии вроде лазеров, плазмы и молний.]]
...
L.message_revival_failed_missing_body = "Вы не были возрождены, так как ваш труп больше не существует."
L.hud_revival_title = "Осталось времени до возрождения:"
L.hud_revival_time = "{time}с"

-- 2020-05-03
L.door_destructible = "Эта дверь разрушаема ({health}HP)"
...
L.corpse_hint_inspect_only = "Нажмите [{usekey}], чтобы осмотреть. Только детективы могут подтвердить смерть."
...
L.dna_help_secondary = "Сменить слот ДНК"
L.dna_help_reload = "Удалить образец"

L.binoc_help_pri = "Опознать тело."
L.binoc_help_sec = "Изменить масштаб."
...
L.help_lang_info = [[
Этот перевод закончен на {coverage}%, в качестве образца использовался английский язык.

Имейте в виду, что эти переводы созданы сообществом. Не стесняйтесь внести свой вклад, если что-то не переведено или переведено неправильно.]]
