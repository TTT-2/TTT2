...
L.spec_help2 = "Pour quitter le mode spectateur, ouvrez le menu en appuyant sur {helpkey}, allez à 'Jouer' et Rejoindre/Quitter le mode spectateur."
...
L.target_c4_armed = "Appuyez sur [{key}] pour désarmer le C4"
...
L.target_pickup_weapon = "Appuyez sur [{key}] pour ramasser l'arme"
...
-- 2020-02-11
L.automoved_to_spec = "(AUTOMATED MESSAGE) J'ai été transféré dans la team Spectateurr parce que j'étais inactif/AFK."
...
L.help_shop_key_desc = "Ouvrez le shop en appuyant sur la touche 'shop' au lieu du menu 'score' pendant la préparation / à la fin du round?"
...
L.label_blur_enable = "Activer le flou de l'arrière-plan VSkin"
L.label_color_enable = "Activer la couleur de fond VSkin"
L.label_minimal_targetid = "Minimaliste Target ID sous le réticule (pas de texte sur le karma, indice, etc.)"
...
L.label_crosshair_gap = "Réticule centrer personnalisé"
...
L.label_crosshair_lines_enable = "Activer les lignes croisées du réticule"
...
L.label_gameplay_dtsprint_enable = "Permettre le sprint en double tap"
L.label_gameplay_dtsprint_anykey = "Continuez à sprinter en double tap jusqu'à ce que vous arrêtiez de bouger"
