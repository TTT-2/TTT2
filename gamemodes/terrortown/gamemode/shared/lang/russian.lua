...
L.f1_settings_dmgindicator_title = "Индикатор урона"
...
-- 2020-01-04
L.doubletap_sprint_anykey = "Продолжать бегать двойным нажатием пока вы не остановитесь"
L.doubletap_sprint_anykey_tip = "Вы будете продолжать бегать пока вы движитесь"

L.disable_doubletap_sprint = "Отключить бег двойным нажатием"
L.disable_doubletap_sprint_tip = "Двойное нажатие на клавишу движения больше не будет вас заставлять бегать"

-- 2020-02-03
L.hold_aim = "Удерживать чтобы прицелиться"
L.hold_aim_tip = "Вы будете продолжать прицеливаться пока вы удерживаете кнопку второстепенной атаки (по умолчанию: ПКМ)"
...
-- 2020-02-11
L.automoved_to_spec = "(АВТОМАТИЧЕСКОЕ СООБЩЕНИЕ) Я был перемещен в наблюдатели потому что был AFK."

-- 2020-02-16
L.door_auto_closes = "Эта дверь закрывается автоматически."
L.door_open_touch = "Войти в дверь чтобы она открылась."
L.door_open_touch_and_use = "Войти в дверь или нажать [{usekey}] чтобы ее открыть."
L.hud_health = "ХП"
