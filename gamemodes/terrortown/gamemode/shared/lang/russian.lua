...
L.limit_left = "Осталось {num} раунд (а/ов) или {time} мин."
...
L.search_timefake = "Смерть наступила примерно за 00:15 до того, как вы его осмотрели."
...
L.entity_draw_halo = "Подсвечивать некоторые энтити, когда вы смотрите на них?"
...
L.set_cross_gap_enable = "Включить пользовательский зазор в прицела"
L.set_cross_gap = "Таможенный зазор в прицеле"
L.set_cross_static_enable = "Включить статический прицел"
...
L.set_cross_outlinethickness = "Толщина контура прицела"
L.set_cross_dot_enable = "Включить точку прицела"

-- ttt2
L.create_own_shop = "Создай свой магазин"
L.shop_link = "Связь с"
L.shop_disabled = "Деактивировать магазин"
L.shop_default = "Используйте стандартный магазин"

L.shop_editor_title = "Редактор Магазина"
L.shop_edit_items_weapong = "Редактор Предметов / Оружия"
L.shop_edit = "Редактировать Магазин"
L.shop_settings = "Настройки"
L.shop_select_role = "Выбрать Роль"
L.shop_edit_items = "Редактор Предметов"
L.shop_edit_shop = "Редактировать Магазин"
L.shop_create_shop = "Создать сторонний магазин"
L.shop_selected = "Выбранная {роль}"
L.shop_settings_desc = "Измените значения, чтобы адапритовать Переменные Магазина. Не забудьте сохранить изменения!"
...
L.f1_settings_gameplay_title = "Геймплей"
...
L.f1_settings_administration_title = "Администратирование"
L.f1_settings_shop_title = "Магазин Экипировки"

L.f1_settings_shop_desc_shopopen = "Должен ли, магазин быть открыт/закрыт вместо окна с счётом во время подготовки / в конце раунда?"
L.f1_settings_shop_title_layout = "Расположение Предметов"
L.f1_settings_shop_desc_num_columns = "Кол-во колонок"
L.f1_settings_shop_desc_num_rows = "Кол-во рядов"
L.f1_settings_shop_desc_item_size = "Размер иконки"
L.f1_settings_shop_title_marker = "Настройки создания предметов"
L.f1_settings_shop_desc_show_slot = "Показать слот"
L.f1_settings_shop_desc_show_custom = "Показать сторонний слот"
L.f1_settings_shop_desc_show_favourite = "Показать избранный слот"

L.f1_shop_restricted = "Индивидуальные изменения магазина экипировки не разрешены на этом сервере. Пожалуйста, свяжитесь с администратором для большей информации."

L.f1_settings_hudswitcher_desc_basecolor = "Основной цвет"
L.f1_settings_hudswitcher_desc_hud_scale = "Размер интерфейса (сбросит позиции)"
L.f1_settings_hudswitcher_button_close = "Закрыть"
L.f1_settings_hudswitcher_desc_reset = "Сброс данных интерфейса"
L.f1_settings_hudswitcher_button_reset = "Сброс"
L.f1_settings_hudswitcher_desc_layout_editor = "Изменить позицию\nи размер элементов"
L.f1_settings_hudswitcher_button_layout_editor = "Редактировать"
L.f1_settings_hudswitcher_desc_hud_not_supported = "! ЭТОТ ИНТЕРФЕЙС НЕ ПОДДЕРЖИВАЕТ РЕДИКТОР !"

L.f1_bind_reset_default = "Сброс"
L.f1_bind_disable_bind = "Отключить"
L.f1_bind_description = "Кликните и нажмите клавишу, чтобы назначить."
L.f1_bind_reset_default_description = "Сбросить до значения по умолчанию."
L.f1_bind_disable_description = "Отключить эту привязку."

L.f1_bind_weaponswitch = "Сменить оружие"
L.f1_bind_sprint = "Бег"

L.ttt2_bindings_new = "Назначена клавиша для {name}: {key}"
L.hud_default = "Интерфейс по умолчанию"
L.hud_force = "Сменить интерфейс"
L.hud_restricted = "Ограниченные интерфейсы"
L.hud_default_failed = "Неудалось установить интерфейс {hudname} как по умолчанию. Вы админ и этот интерфейс существует?"
L.hud_forced_failed = "Неудалось сменить интерфейс {hudname}. Вы админ и этот интерфейс существует?"
L.hud_restricted_failed = "Неудалось ограничить интерфейс {hudname}. Вы админ?"

L.shop_role_select = "Выберите роль"
L.shop_role_selected = "Магазин для {roles} был выбран!"
L.shop_search = "Поиск"

L.button_save = "Сохр."

L.disable_spectatorsoutline = "Деактивировать подсвечивание наблюдателей"
L.disable_spectatorsoutline_tip = "Деактивирует подсвечивание возле объектов, контролируемых наблюдателями (+Производительность)"

L.disable_overheadicons = "Деактивировать иконки ролей"
L.disable_overheadicons_tip = "Деактивирует иконки ролей вверху для всех игроков (+Производительность)"
