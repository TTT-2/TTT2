...
L.item_disg = "Disfraz"
L.item_disg_desc = [[
Esconde tu ID mientras está en uso. Además evade ser la última persona vista por un muerto.
...
L.sipistol_desc = [[
Pistola de bajo sonido, usa munición de pistola común.
...
Úsalo en cuerpos frescos para encontrar el ADN del asesino y así encontrarlo para capturarlo.]]
...
¡Eres un traidor! No tendrás camaradas esta ronda.
...
¡Eres un traidor! Colabora con tus camaradas asesinando a todos los demás.
