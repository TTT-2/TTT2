...
--L.help_rolelayering_roleselection = "The role selection process is split into two passes. In the first pass base roles are disctributed. Baseroles are innocent, traitor and those listed in the forms below. The second pass is used to upgrade those baseroles to a subrole."
