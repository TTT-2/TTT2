...
L.submenu_administration_random_shop = "ランダムショップ"
...
L.desc_event_kill_blowup = "{victim}は吹き飛んだ"
L.desc_event_kill_blowup_trap = "{victim}は{trap}によって吹き飛ばされた"

L.desc_event_kill_tele_self = "{victim}は手榴弾で自爆した"
L.desc_event_kill_sui = "{victim}は何かを受け入れられず自殺した"
L.desc_event_kill_sui_using = "{victim}は{tool}を使用して自殺した"

L.desc_event_kill_fall = "{victim}は転落死した"
L.desc_event_kill_fall_pushed = "{victim}は{attacker}に押されて転落死"
L.desc_event_kill_fall_pushed_using = "{victim}は{attacker}に{trap}で押されて転落死"

L.desc_event_kill_shot = "{victim}は{attacker}に撃たれた"
L.desc_event_kill_shot_using = "{victim}は{attacker}に{weapon}で撃たれた"

L.desc_event_kill_drown = "{victim}は{attacker}によって溺死させられた"
L.desc_event_kill_drown_using = "{victim}は{attacker}が{trap}を起動したことにより溺死させられた"

L.desc_event_kill_boom = "{victim}は{attacker}によって爆破された"
L.desc_event_kill_boom_using = "{victim}は{attacker}の使用した{trap}によって吹き飛ばされた"

L.desc_event_kill_burn = "{victim}は{attacker}によって焼かれた"
L.desc_event_kill_burn_using = "{victim}は{attacker}の仕組んだ{trap}により燃やされた"

L.desc_event_kill_club = "{victim}は{attacker}によって殴られた"
L.desc_event_kill_club_using = "{victim}は{attacker}の{trap}でしたたかに殴り殺された"

L.desc_event_kill_slash = "{victim}は{attacker}に刺された"
L.desc_event_kill_slash_using = "{victim}は{attacker}に{trap}で切り刻まれた"

L.desc_event_kill_tele = "{victim}は{attacker}により手榴弾で爆殺された"
L.desc_event_kill_tele_using = "{victim}は{attacker}が仕掛けた{trap}により粉々にされた"

L.desc_event_kill_goomba = "{victim}は巨大な{attacker}により踏み潰された"

L.desc_event_kill_crush = "{victim}は{attacker}により押し潰された"
L.desc_event_kill_crush_using = "{victim}は{attacker}の{trap}により押し潰された"

L.desc_event_kill_other = "{victim}は{attacker}により殺害された"
L.desc_event_kill_other_using = "{victim}は{attacker}の使用した{trap}により殺害された"
