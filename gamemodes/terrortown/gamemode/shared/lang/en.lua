...
L.shopeditor_name_random_shops = "Random Shops"
L.shopeditor_desc_random_shops = "Should shops be randomized?"
L.shopeditor_name_random_shop_items = "Random Items"
L.shopeditor_desc_random_shop_items = "How many items should be available?"
L.shopeditor_name_random_team_shops = "Team Shops"
L.shopeditor_desc_random_team_shops = "Should shops be the same for every player in one team?"
L.shopeditor_name_random_shop_reroll = "Shop Reroll"
L.shopeditor_desc_random_shop_reroll = "Should rerolling items be available?"
L.shopeditor_name_random_shop_reroll_cost = "Reroll Cost"
L.shopeditor_desc_random_shop_reroll_cost = "How much should rerolling cost?"
L.shopeditor_name_random_shop_reroll_per_buy = "Auto Reroll After Buy"
L.shopeditor_desc_random_shop_reroll_per_buy = "Should shops be automatically rerolled after an item was bought?"