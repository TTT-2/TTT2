...
L.desc_event_kill_blowup = "{victim} blew themselves up"
L.desc_event_kill_blowup_trap = "{victim} was blown up by {trap}"

L.desc_event_kill_tele_self = "{victim} telefragged themselves"
L.desc_event_kill_sui = "{victim} couldn't take it and killed themselves"
L.desc_event_kill_sui_using = "{victim} killed themselves using {tool}"

L.desc_event_kill_fall = "{victim} fell to their death"
L.desc_event_kill_fall_pushed = "{victim} fell to their death after {attacker} pushed them"
L.desc_event_kill_fall_pushed_using = "{victim} fell to their death after {attacker} used {trap} to push them"

L.desc_event_kill_shot = "{victim} was shot by {attacker}"
L.desc_event_kill_shot_using = "{victim} was shot by {attacker} using a {weapon}"

L.desc_event_kill_drown = "{victim} was drowned by {attacker}"
L.desc_event_kill_drown_using = "{victim} was drowned by {trap} triggered by {attacker}"

L.desc_event_kill_boom = "{victim} was exploded by {attacker}"
L.desc_event_kill_boom_using = "{victim} was blown up by {attacker} using {trap}"

L.desc_event_kill_burn = "{victim} was fried by {attacker}"
L.desc_event_kill_burn_using = "{victim} was burned by {trap} due to {attacker}"

L.desc_event_kill_club = "{victim} was beaten up by {attacker}"
L.desc_event_kill_club_using = "{victim} was pummeled to death by {attacker} using {trap}"

L.desc_event_kill_slash = "{victim} was stabbed by {attacker}"
L.desc_event_kill_slash_using = "{victim} was cut up by {attacker} using {trap}"

L.desc_event_kill_tele = "{victim} was telefragged by {attacker}"
L.desc_event_kill_tele_using = "{victim} was atomized by {trap} set by {attacker}"

L.desc_event_kill_goomba = "{victim} was crushed by the massive bulk of {attacker}"

L.desc_event_kill_crush = "{victim} was crushed by {attacker}"
L.desc_event_kill_crush_using = "{victim} was crushed by {trap} of {attacker}"

L.desc_event_kill_other = "{victim} was killed by {attacker}"
L.desc_event_kill_other_using = "{victim} was killed by {attacker} using {trap}"
