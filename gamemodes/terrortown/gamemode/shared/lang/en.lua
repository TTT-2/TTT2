...
L.submenu_gameplay_
roles_title = "Avoid role selection"
...
L.help_targetid_info = "TargetID is the information rendered when pointing your crosshair on an entity. Its color can be configured in the 'General' tab."
...
Keep in mind that these translations are community-based. Feel free to contribute if something is missing or incorrect.]]
