...
local function AddFavorite(steamid, subrole, id)
    local query = (
        "INSERT INTO ttt_bem_fav VALUES('"
        .. steamid
        .. "','"
        .. subrole
        .. "','"
...
local function RemoveFavorite(steamid, subrole, id)
    local query = (
        "DELETE FROM ttt_bem_fav WHERE guid = '"
        .. steamid
        .. "' AND role = '"
        .. subrole
        .. "' AND weapon_id = '"
...
local function GetFavorites(steamid, subrole)
    local query = (
        "SELECT weapon_id FROM ttt_bem_fav WHERE guid = '"
        .. steamid
        .. "' AND role = '"
        .. subrole
        .. "'"
    ...
    for k = 1, #itms do
        ...
        then
            ...
            elseif item.itemModel then
                ...
                ErrorNoHaltWithStack("Equipment item does not have model or material specified:" .. equipName)
                PrintTable(item)
