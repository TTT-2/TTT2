...
function SWEP:Initialize()
	if CLIENT then
		self:AddTTT2HUDHelp(LANG.TryTranslation("dna_help_primary"), LANG.TryTranslation("dna_help_secondary"))
		self:AddHUDHelpLine(LANG.TryTranslation("dna_help_reload"), Key("+reload", "R"))
