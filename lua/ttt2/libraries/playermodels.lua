...
-- @param string name The name of the model
-- @param function OnReceiveFunc?(value) only for the client the function to be called with the returned value if the model is selectable
...
-- @warning As client you must give an OnReceiveFunction as data might be gathered from the server first
-- @param string name The name of the model
-- @param function OnReceiveFunc?(value) only for the client  the function to be called with the returned value if the model is hattable
