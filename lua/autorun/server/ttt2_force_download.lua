...
resource.AddFile("materials/vgui/ttt/vskin/helpscreen/thirdparty.vmt")
...
-- particles
resource.AddFile("particles/entities/entities/ttt_confgrenade_proj/electric_explosion.pcf")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/energy_electric.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/energy_splash.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/energy_swave_warp.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/softwave_normal.vtf")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/beam_electrical.vtf")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/beam_electrical_ob.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/beam_smoke_01.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/fastsidesprites/fastsidesprite128_v2.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/fire.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/flares/flare.vtf")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/flares/flare_nodepth_minmax.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/glow_01.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/glow_02.vtf")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/glow_02_additive.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/glow_03.vtf")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/glow_03_additive.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/glow_03_basic.vmt")
resource.AddFile("materials/particle/entities/entities/ttt_confgrenade_proj/electric_explosion/mph_glow.vmt")

-- stock game effects
resource.AddFile("sound/entities/entities/ttt_basegrenade_proj/impact.wav")
resource.AddFile("sound/entities/entities/ttt_basegrenade_proj/toss.wav")
resource.AddFile("sound/entities/entities/ttt_confgrenade_proj/cartoon_impact.wav")
resource.AddFile("sound/entities/entities/ttt_smokegrenade_proj/airy_boom.wav")
resource.AddFile("sound/ttt2/sfx/extinguish_fizzle.wav")
