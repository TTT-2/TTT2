...
L.round_restart = "遊戲被管理者強制重新開始。"

L.round_traitors_one = "叛徒，你將孤單。"
...
L.win_nones = "無人勝出！（平手）"
L.win_showreport = "來看看 {num} 秒的回合總結吧！"

L.limit_round = "達到回合限制。即將載入下一張地圖。"
L.limit_time = "達到時間限制。即將載入下一張地圖。"
L.limit_left = "新地圖將在 {num} 回合或 {time} 分鐘後切換。"

-- Credit awards
L.credit_all = "你的陣營因為表現獲得了 {num} 點積分。"
L.credit_kill = "你殺死 {role} 獲得了 {num} 點積分。"

-- Karma
L.karma_dmg_full = "你的人品為 {amount}，因此本回合你將造成正常傷害。"
L.karma_dmg_other = "你的人品是 {amount}，因此本回合你造成的傷害將減少 {num}%"
...
L.body_confirm = "{finder} 確認了 {victim} 的死亡。"

L.body_call = "{player} 請探長前來檢查 {victim} 的屍體！"
L.body_call_error = "你必須先確定該玩家的死才能呼叫探長！"

L.body_burning = "好燙！這個屍體著火了！"
L.body_credits = "你在屍體上找到 {num} 積分！"
...
L.equip_status = "購買選單"
L.equip_cost = "你的積分剩下 {num} 點。"
L.equip_help_cost = "每件裝備都需要花費 1 點點數。"

L.equip_help_carry = "你只能在擁有空位時購買裝備。"
L.equip_carry = "你能攜帶這件裝備。"
L.equip_carry_own = "你已經擁有這件裝備。"
L.equip_carry_slot = "已擁有武器欄第 {slot} 項的武器。"
L.equip_carry_minplayers = "伺服器玩家數量不足以啟用這個武器。"

L.equip_help_stock = "每回合你只能買一件相同的裝備。"
L.equip_stock_deny = "這件裝備賣空了。"
L.equip_stock_ok = "這件裝備有庫存。"

L.equip_custom = "此伺服器的自訂裝備。"
...
L.disg_name = "偽裝器"
L.disg_menutitle = "偽裝器控制"
L.disg_not_owned = "你沒有偽裝器！"
L.disg_enable = "執行偽裝"

L.disg_help1 = "偽裝開啟後，別人瞄準你時將不會看見你的名字，生命以及人品。除此之外，你也能躲避探長的雷達。"
L.disg_help2 = "可直接在主選單外，使用數字鍵來切換偽裝。你也可以用控制台指令綁定指令 ttt_toggle_disguise。"

-- Radar tab in equipment menu
L.radar_name = "雷達"
L.radar_menutitle = "雷達控制"
L.radar_not_owned = "你沒有雷達！"
L.radar_scan = "執行掃描"
L.radar_auto = "自動重複掃描"
L.radar_help = "掃描結果會顯示 {num} 秒，接著雷達充電後你便可以再次使用。"
L.radar_charging = "你的雷達還在充電裡！"

-- Transfer tab in equipment menu
L.xfer_name = "轉移"
L.xfer_menutitle = "轉移積分"
L.xfer_send = "發送積分"

L.xfer_no_recip = "接收者無效，發送失敗。"
L.xfer_no_credits = "積分不足，無法轉移"
L.xfer_success = "成功向 {player} 發送積分！"
L.xfer_received = "{player} 給你 {num} 點數。"

-- Radio tab in equipment menu
L.radio_name = "收音機"
L.radio_help = "點擊按鈕，讓收音機播放音效。"
L.radio_notplaced = "你必須放置收音機以播放音效。"
...
L.intro_help = "若你是該模式的新手，請按F1查看模式教學！"
...
L.search_role_inno = "這個人是無辜的恐怖份子。"

L.search_words = "直覺告訴你這個人的遺言是： {lastwords}"
L.search_armor = "他穿著非標準裝甲。"
L.search_disg = "他持有一個能隱匿身分的裝置"
L.search_radar = "他持有像雷達的裝備，已經無法使用了。"
L.search_c4 = "你在他口袋中找到了一本筆記。記載著第 {num} 根線才能解除炸彈。"
...
L.search_dmg_stab = "他是被刺擊揮砍後，迅速失血致死的。"
L.search_dmg_burn = "聞起來像燒焦的恐怖分子.."
L.search_dmg_tele = "看起來他的DNA以超光速粒子之形式散亂在附近。"
L.search_dmg_car = "他穿越馬路時被一個粗心的駕駛碾死了。"
L.search_dmg_other = "你無法找到這恐怖分子的具體死因。"

L.search_weapon = "死者是被 {weapon} 所殺。"
L.search_head = "最後一擊打在頭上。完全沒機會叫喊。"
L.search_time = "他大約在你搜尋前的 {time} 死亡。"
L.search_dna = "用DNA掃描器檢索兇手的DNA標本，DNA樣本大約在 {time} 前開始衰退。"

L.search_kills1 = "你找到一個名單，記載他發現的死者： {player}"
L.search_kills2 = "你找到了一個名單，記載著他殺的這些人："
L.search_eyes = "透過你的探查技能，你確信他臨死前見到的最後一個人是 {player}。兇手，還是巧合？"

-- Scoreboard
L.sb_playing = "你正在玩的伺服器是..."
L.sb_mapchange = "地圖將於 {num} 個回合或是 {time} 後更換。"
L.sb_mapchange_disabled = "地圖更換已停用。"
...
L.sb_info_help = "搜尋此玩家的屍體，可以取得一些線索。"
...
L.buy_no_stock = "無法購買此裝備：你已經擁有它了。"
L.buy_pending = "你已訂購此裝備，請等待配送。"
L.buy_received = "你已收到此裝備。"

L.drop_no_room = "你沒有足夠空間可以存放新武器！"
...
一旦持有，雷達會開始自動掃描。 使用該頁面的雷達選單來設定。 ]]

L.item_disg = "偽裝"
L.item_disg_desc = [[
啟用時，你的ID將被隱藏；也可避免探長在屍體上找到死者生前見到的最後一個人。

需要啟用時，請使用本頁面的偽裝選單或按下小鍵盤回車鍵。 ]]

-- C4
L.c4_hint = "按下 {usekey} 來安置或拆除C4。"
L.c4_disarm_warn = "你所安置的C4已被拆除。"
L.c4_armed = "C4安置成功。"
...
L.c4_arm_attempts = "拆除C4時，6條引線中有 {num} 條會立即引發爆炸。"
...
L.c4_disarm = "拆除C4"
L.c4_disarm_cut = "點擊以剪下 {num} 號引線"

L.c4_disarm_t = "剪斷引線以拆除C4。你是叛徒，因此每條引線都是安全的，但其他人可就沒那麼容易了！"
L.c4_disarm_owned = "剪斷引線以拆除C4。你是安置此C4的人，任何引線都能成功拆除。"
L.c4_disarm_other = "剪斷正確的引線以拆除C4。如果你剪錯的話，後果不堪設想！"

L.c4_status_armed = "安置"
L.c4_status_disarmed = "拆除"

-- Visualizer
L.vis_name = "顯像器"
L.vis_hint = "按下 {usekey} 鍵撿起它（僅限偵探）。"

L.vis_desc = [[
可讓犯罪現場顯影化的儀器。

分析屍體，顯出死者被殺害時的情況，但僅限於死者被槍殺時。 ]]

-- Decoy
L.decoy_name = "雷達誘餌"
L.decoy_no_room = "你無法攜帶雷達誘餌。"
L.decoy_broken = "你的雷達誘餌被摧毀了！"

L.decoy_short_desc = "這個誘餌會為其他陣營顯示一個假雷達訊號"
L.decoy_pickup_wrong_team = "這個誘餌屬於其他陣營，你無法撿起"

L.decoy_desc = [[
顯示假的雷達訊號給探長，探長執行DNA掃描時，將會顯示雷達誘餌的位置作為代替。 ]]
...
不限制使用次數。 若你持有此設備，拆除C4時會輕鬆許多。 ]]

-- Flare gun
L.flare_name = "信號槍"

L.flare_desc = [[
可用來燒毀屍體，使它們永遠不會被發現。 該武器有有彈藥限制。
...
L.hstation_broken = "你的醫療站被摧毀了！"
L.hstation_help = "{primaryfire} 安置了一個醫療站。"

L.hstation_desc = [[
安放後，允許人們用其治療自己。

充能速度相當緩慢。 所有人都可以使用，醫療站可以受到傷害。 每位使用者會留下可採集的DNA樣本。 ]]
...
-- Poltergeist
L.polter_desc = [[
放置震動器在物體上，使它們危險地四處飛行。

能量爆炸會使附近的人受到傷害。 ]]

-- Radio
L.radio_broken = "你的收音機已被摧毀！"
L.radio_help_pri = "{primaryfire} 安置了收音機。"

L.radio_desc = [[
播放音效來誤導或欺騙玩家。

將收音機安置下來，然後用該頁面的收音機選單播放。 ]]
...
L.dna_limit = "已達到最大採集額度，請先移除舊樣本。"
L.dna_decayed = "兇手的DNA樣本已經消失。"
L.dna_killer = "成功採集到兇手的DNA樣本！"
L.dna_duplicate = "配對！你的掃描器裡已經有這個DNA樣本了。"
L.dna_no_killer = "DNA樣本無法檢索（兇手已離線？）"
L.dna_armed = "炸彈已啟動！趕緊拆除它！"
L.dna_object = "在目標上採集到 {num} 個新DNA樣本。"
L.dna_gone = "區域內沒偵測到可採集之DNA樣本。"

L.dna_desc = [[
採集物體上的DNA樣本，並用其尋找對應的主人。

使用在屍體上，採集殺手的DNA並追蹤他。 ]]

-- Magneto stick
L.magnet_name = "電磁棍"
L.magnet_help = "{primaryfire} 定在牆上。"
...
L.tele_no_ground = "你必須站在地面才能傳送！"
L.tele_no_crouch = "蹲著的時候不能傳送！"
L.tele_no_mark = "標記傳送地點後才能傳送。"

L.tele_no_mark_ground = "站在地面上才能標記傳送地點！"
L.tele_no_mark_crouch = "站起來才能標記傳送點！"

L.tele_help_pri = "{primaryfire} 傳送到已標記的傳送地點。"
...
L.ammo_smg1 = "衝鋒槍彈藥"
L.ammo_buckshot = "霰彈槍彈藥"
L.ammo_357 = "步槍彈藥"
L.ammo_alyxgun = "沙漠之鷹彈藥"
L.ammo_ar2altfire = "信號槍彈藥"
...
L.target_credits = "搜尋屍體以獲得未被消耗積分"

-- HUD buttons with hand icons that only traitors can see
L.tbut_single = "一次性"
L.tbut_reuse = "重複使用"
L.tbut_retime = "{num} 秒可後再使用"
L.tbut_help = "按下 [{usekey}] 鍵使用"

-- Spectator muting of living/dead
L.mute_living = "靜音存活玩家"
L.mute_specs = "靜音觀察者"
L.mute_all = "全部靜音"
L.mute_off = "取消靜音"

-- Spectators and prop possession
L.punch_title = "飛擊量表" --"PUNCH-O-METER"
L.punch_help = "按下行走鍵或跳躍鍵以推撞物品；按蹲下鍵則離開物品控制。"
L.punch_bonus = "你的分數較低，飛擊量表上限減少 {num}"
L.punch_malus = "你的分數較高，飛擊量表上限增加 {num}！"
...
L.idle_popup = [[
你掛機了 {num} 秒，所以被轉往觀察者模式。 當你位於此模式時，將不會在回合開始時重生。

你可在任何時間取消觀察者模式，按下 {helpkey} 並在選單取消勾選\"觀察者模式\"即可。 當然，你也可以選擇立刻關閉它。 ]]

L.idle_popup_close = "什麼都不做"
L.idle_popup_off = "立刻關閉觀察者模式"

L.idle_warning = "警告：你已掛機一段時間，如果接下來沒有動作將進入觀察者模式。"

L.spec_mode_warning = "你位於觀察者模式所以不會在回合開始時重生。若要關閉此模式，按下F1並取消勾選\"觀察者模式\"即可。"
...
L.tip2 = "將C4爆炸時間設定更長，可增加引線數量，使拆彈者失敗可的能性大幅上升，且能讓C4的嗶嗶聲更輕更慢。"

L.tip3 = "探長能在屍體查出誰是\"死者最後看見的人\"。若是遭到背後攻擊，最後看見的將不會是兇手。"

L.tip4 = "在被你的屍體被發現並確認之前，沒人知道你已經死亡。"

L.tip5 = "叛徒殺死探長時會立即得到一點點數。"

L.tip6 = "一名叛徒死後，探長將得到一點點數作為獎勵。"

L.tip7 = "叛徒殺害一定數量的無辜者後，全體都會獲得一點積分作為獎勵。"

L.tip8 = "叛徒和探長能從同伴屍體上取得未被消耗的積分。"

L.tip9 = "促狹鬼將使物體變得極度危險。促狹鬼調整過的物體將產生爆炸能量傷害接近它的人。"

L.tip10 = "叛徒與探長應保持注意螢幕右上方的紅色訊息，這對你無比重要。"

L.tip11 = "叛徒或探長和同伴配合得好時會獲得額外積分。請善用這些點數！"

L.tip12 = "探長的DNA掃描器可使用在武器或道具上，找到曾使用它的玩家的位置。用在屍體或C4上效果將更好！"

L.tip13 = "太靠近你殺害的人的話，DNA將殘留在屍體上，探長的DNA掃描器會以此找到你的正確位置。切記，殺了人最好將屍體藏好！"

L.tip14 = "殺人時離被害者越遠，殘留在屍體上的DNA就會越快消失！"

L.tip15 = "你是叛徒而且想進行狙擊？試試偽裝吧！若你狙殺失手，逃到安全的地方，取消偽裝，就沒人知道是你開的槍了！"

L.tip16 = "作為叛徒，傳送器可幫助你逃脫追踪，並讓你得以迅速穿過整個地圖。請隨時確保有個安全的傳送標記。"

L.tip17 = "是否遇過無辜者群聚在一起而難以下手？請試試用收音機發出C4嗶嗶聲或交火聲，讓他們分散。"

L.tip18 = "叛徒可以在選單上使用已放置的收音機，依序點擊想播放的聲音，就會按順序排列播放。"

L.tip19 = "探長若有多餘積分，可將拆彈器交給一位可信任的無辜者，將危險的C4交給他們，自己全神貫注地調查與處決叛徒。"
...
L.tip25 = "探長確認屍體後，相關資訊將在計分板公佈，如要查看只需點擊死者之名字即可。"
...
L.tip31 = "作為觀察者，按下 {duckkey} 能固定視角並在遊戲內移動遊標，可以點擊提示欄裡的按鈕。此外，再次按下 {duckkey} 會解除並恢復預設視角控制。"

L.tip32 = "使用撬棍時，按下右鍵可推開其他玩家。"

L.tip33 = "使用武器瞄準器射擊將些微提升你的精準度，並降低後座力。蹲下則不會。"

L.tip34 = "煙霧彈在室內相當有效，尤其是在擁擠的房間中製造混亂。"

L.tip35 = "叛徒，請記得你能搬運屍體並將它們藏起來，避開無辜者與探長的耳目。"

L.tip36 = "按下 {helpkey} 可以觀看教學，其中包含了重要的遊戲資訊。"

L.tip37 = "在計分板上，點擊活人玩家的名字，可以選擇一個標記（如令人懷疑的或友好的）記錄這位玩家。此標誌會在你的準心指向該玩家時顯示 。"

L.tip38 = "許多需放置的裝備（如C4或收音機）可以使用右鍵放在牆上。"

L.tip39 = "拆除C4時失誤導致的爆炸，比起直接引爆時來得小。"

L.tip40 = "若時間上顯示\"急速模式\"，此回合的時間會很短，但每位玩家的死亡都將延長時間（就像TF2的佔點模式）。延長時間將迫使叛徒加緊 腳步。"

-- Round report
L.report_title = "回合報告"

-- Tabs
L.report_tab_hilite = "亮點"
L.report_tab_hilite_tip = "回合亮點"
L.report_tab_events = "事件"
L.report_tab_events_tip = "發生在此回合的亮點事件"
L.report_tab_scores = "分數"
L.report_tab_scores_tip = "本回合單一玩家所獲得的分數"
...
L.aw_exp1_text = "決心研究C4。{num} 位受試者證明了他的理論。"

L.aw_exp2_title = "就地研究"
L.aw_exp2_text = "測試自己的抗爆炸能力，顯然完全不夠高。"
...
L.aw_fst3_text = "第一殺便將無辜者同伴誤認為叛徒，真是烏龍。"

L.aw_fst4_title = "吹響號角"
L.aw_fst4_text = "殺害一名叛徒，為無辜者陣營吹響了號角。"

L.aw_all1_title = "鶴立雞群"
L.aw_all1_text = "對無辜者團隊的每一個擊殺負責。"

L.aw_all2_title = "孤狼"
L.aw_all2_text = "對叛徒團隊的每一個擊殺負責。"

L.aw_nkt1_title = "老大！我幹掉一個！"
L.aw_nkt1_text = "在一名無辜者落單時策劃了一場謀殺，漂亮！"

L.aw_nkt2_title = "一舉兩得"
...
L.aw_nkt4_text = "吃了無辜者當晚餐。共吃了 {num} 人。"

L.aw_nkt5_title = "反恐特工"
L.aw_nkt5_text = "按恐怖分子人頭收錢。現在已經買得起豪華遊艇了。"

L.aw_nki1_title = "背叛這個試試！"
L.aw_nki1_text = "找出了一個叛徒，然後殺死了一個叛徒。簡單吧？"

L.aw_nki2_title = "申請進入正義連隊"
L.aw_nki2_text = "將兩名叛徒送下地獄。"

L.aw_nki3_title = "恐怖分子會夢到叛徒羊嗎？"
L.aw_nki3_text = "讓三位叛徒安息。"

L.aw_nki4_title = "內部事件部門"
L.aw_nki4_text = "按叛徒人頭收錢。現在已經買得起第五個游泳池了。"

L.aw_fal1_title = "不，龐德先生，我希望你跳下去"
L.aw_fal1_text = "將一個人推下致死的高度。"
...
L.aw_hed1_title = "高效能"
L.aw_hed1_text = "發現爆頭的樂趣，並且殺死了 {num} 名敵人。"

L.aw_hed2_title = "神經內科"
L.aw_hed2_text = "近距離將 {num} 名玩家的頭取出，完成自己的腦神經研究。"

L.aw_hed3_title = "從遊戲裡學來的"
L.aw_hed3_text = "好好應用了暴力遊戲的經驗，爆了 {num} 顆頭。"

L.aw_cbr1_title = "物理學聖劍"
L.aw_cbr1_text = "應用了物理學原理，向 {num} 證明了自己的畢業論文。"
...
L.aw_pst2_text = "用手槍殺了 {num} 人的小隊。我們推測他槍管裡頭有個微型霰彈槍。"

L.aw_sgn1_title = "簡單模式"
L.aw_sgn1_text = "用霰彈槍近距離殺了 {num} 名玩家。切。"

L.aw_sgn2_title = "一千顆小彈丸"
L.aw_sgn2_text = "不喜歡自己的霰彈槍，打算送人。已經有 {num} 位受贈人接受了這個禮物。"

L.aw_rfl1_title = "把準心對準目標扣下板機…"
L.aw_rfl1_text = "用一把好槍和一個沉穩的手終結了 {num} 名玩家的生命。"

L.aw_rfl2_title = "你的腦袋冒出來了！"
L.aw_rfl2_text = "十分了解他的狙擊槍，其他 {num} 名玩家隨即也了解了他的狙擊槍。"

L.aw_dgl1_title = "這簡直像是小型狙擊槍"
L.aw_dgl1_text = "用沙漠之鷹嫻熟地殺了 {num} 名玩家。"

L.aw_dgl2_title = "老鷹大師"
L.aw_dgl2_text = "用他手中的沙漠之鷹殺了 {num} 名玩家。"

L.aw_mac1_title = "按下板機，然後祈禱"
L.aw_mac1_text = "用MAC10衝鋒槍殺了 {num} 名玩家，但別提他需要多少子彈。"

L.aw_mac2_title = "單槍老太婆"
L.aw_mac2_text = "好奇如果他能有兩把衝鋒槍會發生什麼事。大概是 {num} 個人頭再翻倍？"

L.aw_sip1_title = "噓！"
L.aw_sip1_text = "用消音手槍射殺了 {num} 人。"

L.aw_sip2_title = "光頭殺手"
L.aw_sip2_text = "用消音手槍無聲地殺死了 {num} 個人。不愧是專業的。"

L.aw_knf1_title = "很刀興見到你"
L.aw_knf1_text = "隔著網線捅死了一個人。"

L.aw_knf2_title = "管製刀具"
L.aw_knf2_text = "不是叛徒，卻找到刀子並用它殺了人。"

L.aw_knf3_title = "開膛手傑克"
L.aw_knf3_text = "在地上撿到 {num} 把匕首，並好好利用了它們。"

L.aw_knf4_title = "女僕長的執著"
L.aw_knf4_text = "用刀子殺死了 {num} 個人。這些刀子都是裙底下找出來的嗎？"

L.aw_flg1_title = "買根菸嗎？"
L.aw_flg1_text = "用燃燒彈點燃了 {num} 人的香煙。"

L.aw_flg2_title = "火上加油"
L.aw_flg2_text = "使 {num} 名玩家葬身於火海。"

L.aw_hug1_title = "子彈龍頭"
L.aw_hug1_text = "和自己的M249很合得來，不知道怎麼打中了 {num} 名玩家。"

L.aw_hug2_title = "耐心機槍手"
L.aw_hug2_text = "從未拋棄心愛的M249，最後用其殺害了 {num} 名玩家。"
...
L.aw_tkl1_title = "抱歉"
L.aw_tkl1_text = "瞄準自己的隊友，不小心扣下板機。"
...
L.aw_tkl4_title = "專業賣隊友！"
L.aw_tkl4_text = "殺了所有同伴！快踢了他！"

L.aw_tkl5_title = "角色扮演"
L.aw_tkl5_text = "在扮演瘋子，所以把大部分的同伴殺死了。"

L.aw_tkl6_title = "痛擊隊友"
L.aw_tkl6_text = "弄不清他屬於哪一隊，並殺死了半數以上的隊友。"

L.aw_tkl7_title = "園丁"
L.aw_tkl7_text = "好好保護自己的草坪，並殺死了四分之一以上的隊友。"

L.aw_brn1_title = "炭烤恐怖分子"
L.aw_brn1_text = "使用燃燒彈點燃數個玩家，把他們烤熟了！"

L.aw_brn2_title = "火化官"
L.aw_brn2_text = "將每一具被他殺死的受害者屍體燃燒乾淨。"

L.aw_brn3_title = "縱火狂"
L.aw_brn3_text = "十分喜歡火焰，以至於用掉了地圖上每一顆燃燒彈。也許應該去看一下醫生。"

L.aw_fnd1_title = "驗屍官"
L.aw_fnd1_text = "在地上發現 {num} 具屍體。"

L.aw_fnd2_title = "屍體收藏家"
L.aw_fnd2_text = "在地上發現了 {num} 具屍體，大概是要搞收藏。"

L.aw_fnd3_title = "死亡的氣味"
L.aw_fnd3_text = "在這回合偶遇屍體共 {num} 次。"

L.aw_crd1_title = "回收"
L.aw_crd1_text = "在同伴屍體上找到了 {num} 點積分。"

L.aw_tod1_title = "痛失勝利"
L.aw_tod1_text = "在他的團隊即將獲得勝利的前幾秒死去。"

L.aw_tod2_title = "垃圾遊戲！"
L.aw_tod2_text = "在這一回合剛開始不久就被殺害。"
...
-- 2018-07-24
L.equip_tooltip_main = "裝備選單"
L.equip_tooltip_radar = "雷達控制"
L.equip_tooltip_disguise = "偽裝器控制"
L.equip_tooltip_radio = "收音機控制"
L.equip_tooltip_xfer = "轉移積分"
...
-- 2019-01-31
L.create_own_shop = "新店"
L.shop_link = "連線"
L.shop_disabled = "停用商店"
L.shop_default = "使用預設商店"

-- 2019-05-05
L.reroll_name = "重選"
L.reroll_menutitle = "重選裝備"
L.reroll_no_credits = "你需要花費 {amount} 積分來重選！"
L.reroll_button = "重選"
L.reroll_help = "使用 {amount} 積分在你的店裡獲得新的隨機裝備！"

-- 2019-05-06
L.equip_not_alive = "在右側選擇身分來查看這個身分的全部裝備。不要忘記標記最愛裝備！"
...
L.shop_edit = "修改商店"
L.shop_settings = "設定"
L.shop_select_role = "選擇身分"
L.shop_edit_items = "修改道具"
L.shop_edit_shop = "修改商店"
L.shop_create_shop = "新自訂商店"
L.shop_selected = "選取 {role}"
L.shop_settings_desc = "改變數值來適應隨機商店參數。不要忘記保存！"

L.bindings_new = "{name} 的新按鍵：{key}"

L.hud_default_failed = "未能將介面 {hudname} 設為預設。你沒有權限，或這個介面不存在。"
L.hud_forced_failed = "未能將介面 {hudname} 設為強制。你沒有權限，或這個介面不存在。"
L.hud_restricted_failed = "未能將介面 {hudname} 設為限制。你沒有權限，或這個介面不存在。"

L.shop_role_select = "選擇身分"
L.shop_role_selected = "選取了 {role} 的商店！"
L.shop_search = "搜尋"

L.spec_help = "點擊來觀察玩家，或對著實體道具按 {usekey} 來附身。"
L.spec_help2 = "若想離開觀察者模式，用 {helpkey} 開啟選單，在「遊戲性」選項中勾選選項。"

-- 2019-10-19
L.drop_ammo_prevented = "有東西阻擋你丟出子彈。"

-- 2019-10-28
L.target_c4 = "按 [{usekey}] 開啟C4選單"
...
L.target_slot_info = "插槽：{slot}"
L.target_pickup_weapon = "按 [{usekey}] 撿起武器"
L.target_switch_weapon = "按 [{usekey}] 和目前武器交換"
L.target_pickup_weapon_hidden = "按 [{walkkey} + {usekey}] 隱密地撿起"
L.target_switch_weapon_hidden = "按 [{walkkey} + {usekey}] 隱密地交換"
L.target_switch_weapon_nospace = "沒有提供給這個武器的插槽"
L.target_switch_drop_weapon_info = "丟棄插槽 {slot} 的 {name}"
L.target_switch_drop_weapon_info_noslot = "插槽 {slot} 沒有可丟棄的武器"

L.corpse_searched_by_detective = "這具屍體被探長搜查"
...
L.hstation_charge = "剩餘充能：{charge}"
L.hstation_empty = "這個醫療站沒有剩餘充能"
L.hstation_maxhealth = "你的生命恢復已滿"
L.hstation_short_desc = "醫療站會逐漸回覆充能"

-- 2019-11-03
L.vis_short_desc = "還原被槍殺的屍體的犯罪現場"
L.corpse_binoculars = "按 [{key}] 用望遠鏡搜尋屍體"
L.binoc_progress = "搜尋進度：{progress}%"

L.pickup_no_room = "你沒有存放這類武器的空間"
L.pickup_fail = "你無法撿起這把武器"
L.pickup_pending = "你已經撿起這把武器，請等到撿起來完成"
...
L.tbut_current_config = "目前設定："
L.tbut_intended_config = "地圖預設設定："
...
-- 2020-02-11
L.automoved_to_spec = "（自動訊息）我因為掛機而被移到了觀察者。"
L.mute_team = "靜音 {team}"
...
L.menu_legacy_title = "舊式外掛"
L.menu_administration_title = "管理"
L.menu_equipment_title = "編輯裝備"
L.menu_shops_title = "編輯商店"

L.menu_changelog_description = "最近版本的一系列最佳化和改變"
L.menu_guide_description = "幫助你開始遊玩 TTT2 並解釋玩法和身分等內容"
L.menu_bindings_description = "將 TTT2 和其插件的功能綁在你想要的鍵位"
L.menu_language_description = "選擇遊戲語言"
L.menu_appearance_description = "調整介面的樣式和效能"
L.menu_gameplay_description = "避免特定身分和其他遊戲相關選項"
L.menu_addons_description = "配置本地插件"
L.menu_legacy_description = "舊TTT的選單，應該已匯入新系統"
L.menu_administration_description = "介面和商店的通用管理選單"
L.menu_equipment_description = "設定裝備的價格，限制，可用性等"
L.menu_shops_description = "為身分添加選單和裝備"
...
L.submenu_appearance_shop_title = "商店設定"
L.submenu_appearance_crosshair_title = "準星"
L.submenu_appearance_dmgindicator_title = "傷害指示"
L.submenu_appearance_performance_title = "效能"
L.submenu_appearance_interface_title = "介面"
L.submenu_appearance_miscellaneous_title = "其他"

L.submenu_gameplay_general_title = "通用"
L.submenu_gameplay_avoidroles_title = "避免特定身分"

L.submenu_administration_hud_title = "HUD 設定"
L.submenu_administration_randomshop_title = "隨機商店"

L.help_color_desc = "此選項啟用後，準星和目標高亮的外框會顯示一個全域通用的顏色"
L.help_scale_factor = "這個比例影響所有介面大小（HUD， vgui 和目標高亮）。螢幕解析度修改後會自動更新這個比例。改變此比例會重設 HUD！"
L.help_hud_game_reload = "這個 HUD 目前無法使用，必須先重新載入遊戲。"
L.help_hud_special_settings = "以下是目前 HUD 的專用設定。"
L.help_vskin_info = "VSkin（vgui 皮膚）是應用在所有選單介面（包括這個）的皮膚。皮膚可以用一個簡單的 Lua 腳本創建，並能改變顏色，大小等參數。"
L.help_targetid_info = "目標高亮（TargetID）是顯示在實體和玩家下面的資訊。可以在通用選單啟用全域顏色。"
L.help_hud_default_desc = "設定全體玩家的預設 HUD。未選擇 HUD 的玩家會使用這個，但已經選擇其他 HUD 的玩家不會受影響。"
L.help_hud_forced_desc = "強制選擇一個 HUD。這會阻止玩家選擇其他 HUD。"
L.help_hud_enabled_desc = "啟用/停用 HUD 來限制玩家選擇它們。"
L.help_damage_indicator_desc = "傷害指示是收到傷害時畫面上出現的標記。若要新增新的主題，請將 png 檔案放置在 'materials/vgui/ttt/damageindicator/themes/' 資料夾中。"
L.help_shop_key_desc = "在回合開始/結束時，按商店鍵是否開啟商店而不是計分板？"

L.label_menu_menu = "選單"
L.label_menu_admin_spacer = "管理員選項"
L.label_language_set = "選擇語言"
L.label_global_color_enable = "啟用全域顏色"
L.label_global_color = "全域顏色"
L.label_global_scale_factor = "全域大小比例"
...
L.label_minimal_targetid = "簡易目標高亮（沒有人品，提示等）"
...
L.label_shop_item_size = "圖示大小"
L.label_shop_show_slot = "顯示裝備插槽"
L.label_shop_show_custom = "顯示自訂標記"
L.label_shop_show_fav = "顯示最愛標記"
L.label_crosshair_enable = "啟用十字準星"
L.label_crosshair_gap_enable = "啟用自訂準星大小"
L.label_crosshair_gap = "自訂準星大小"
L.label_crosshair_opacity = "準星透明度"
L.label_crosshair_ironsight_opacity = "瞄準時準星透明度"
L.label_crosshair_size = "準星長"
...
L.label_performance_ohicon_enable = "啟用頭上身分圖示"
L.label_interface_tips_enable = "啟用觀察時畫面下方的遊戲提示"
L.label_interface_popup = "回合開始訊息持續時間"
L.label_interface_fastsw_menu = "啟用快速切換選單"
L.label_inferface_wswitch_hide_enable = "啟用武器選單自動關閉"
...
L.label_gameplay_dtsprint_enable = "啟用雙擊衝刺"
L.label_gameplay_dtsprint_anykey = "衝刺時任何方向鍵都會持續衝刺"
L.label_hud_default = "預設 HUD"
L.label_hud_force = "強制 HUD"

L.label_bind_weaponswitch = "撿起武器"
L.label_bind_sprint = "衝刺"
L.label_bind_voice = "全域語言"
L.label_bind_voice_team = "團隊語言"

L.label_hud_basecolor = "基礎顏色"

L.label_menu_not_populated = "這個子選單什麼都沒有。"

L.header_bindings_ttt2 = "TTT2 鍵位"
L.header_bindings_other = "其他鍵位元"
L.header_language = "語言設定"
L.header_global_color = "選擇全域顏色"
L.header_hud_select = "選擇 HUD"
L.header_hud_customize = "自訂 HUD"
L.header_vskin_select = "選擇並自訂 VSkin"
L.header_targetid = "目標高亮設定"
L.header_shop_settings = "裝備選單設定"
L.header_shop_layout = "裝備頁面佈局"
L.header_shop_marker = "裝備標記設定"
L.header_crosshair_settings = "準星設定"
L.header_damage_indicator = "傷害指示設定"
L.header_performance_settings = "效能設定"
L.header_interface_settings = "介面設定"
L.header_gameplay_settings = "遊戲性設定"
L.header_roleselection = "啟用身分指派"
L.header_hud_administration = "選擇預設與強制 HUD"
L.header_hud_enabled = "啟用/停用 HUDs"
...
L.item_no_fall_damage_desc = [[讓你免疫跌倒傷害。 ]]
...
L.corpse_hint_inspect_only = "按 [{usekey}] 搜尋。只有偵探能確認死亡。"
L.corpse_hint_inspect_only_credits = "按 [{usekey}] 取得積分。只有偵探能確認死亡。"
...
L.dna_help_secondary = "切換目前DNA"
L.dna_help_reload = "刪除目前樣本"

L.binoc_help_pri = "確認屍體"
L.binoc_help_sec = "切換放大倍率"

L.vis_help_pri = "丟棄目前裝置。"

L.decoy_help_pri = "安置誘餌。"

-- 2020-08-07
L.pickup_error_spec = "作為觀察者你無法撿起這個。"
L.pickup_error_owns = "你已經有這個武器，無法再撿起來"
L.pickup_error_noslot = "你沒有對應空槽位，無法撿起這個"

-- 2020-11-02
L.lang_server_default = "伺服器預設"
L.help_lang_info = [[
該語言翻譯已經{coverage}%，未翻譯的文字將會以英文作為預設的參考。
...
L.label_bind_clscore = "開啟回合總結"
L.title_player_score = "{player}的分數："

L.label_show_events = "顯示相關的事件："
L.button_show_events_you = "你"
L.button_show_events_global = "全域"
...
L.tooltip_finish_score_timelimit = "逾時：{score}"
...
L.title_event_creditfound = "積分被發現"
L.title_event_finish = "本回合已經結束"
L.title_event_game = "新回合已經開始"
L.title_event_kill = "一位玩家被殺害"
L.title_event_respawn = "一個玩家復活了"
L.title_event_rolechange = "一名玩家改變了它的角色或陣營"
L.title_event_selected = "角色指派"
L.title_event_spawn = "一名玩家生成了"

L.desc_event_bodyfound = "{finder} ({firole} / {fiteam}) 發現了 {found} ({forole} / {foteam}) 的屍體。屍體上有 {credits} 個積分。"
...
L.desc_event_creditfound = "{finder} ({firole} / {fiteam}) 在 {found} ({forole} / {foteam}) 的屍體中找到了 {credits} 個積分。"
L.desc_event_finish = " 該回合持續了 {minutes}:{seconds}。有 {alive} 個玩家活到了最後。"
L.desc_event_game = "新的回合已經開始。"
L.desc_event_respawn = "{player} 復活了。"
L.desc_event_rolechange = "{player} 從 {orole} ({oteam}) 將自己改為 {nrole} ({nteam})。"
...
L.desc_event_kill_tele_self = "{victim} ({vrole} / {vteam}) 被自己殺了給傳送。"
...
L.desc_event_kill_boom_using = "{victim} ({vrole} / {vteam}) 被 {attacker} ({arole} / {ateam}) 用 {trap} 炸掉。"
...
-- 2021-05-07
L.header_random_shop_administration = "隨機商店設定"
L.header_random_shop_value_administration = "平衡設定"

L.shopeditor_name_random_shops = "啟用隨機商店"
L.shopeditor_desc_random_shops = [[隨機商店只提供每位玩家一套有限的隨機化裝備。
陣營商店迫使一個陣營中的所有玩家擁有相同的套裝，而不是客製化。
...
-- 2021-06-04
L.header_equipment_setup = "裝備設定"
L.header_equipment_value_setup = "平衡設定"

L.equipmenteditor_name_not_buyable = "可以購買"
L.equipmenteditor_desc_not_buyable = "如果停用，該裝備將不會顯示在商店裡。分配了這種裝備的角色仍然會獲得它。"
...
L.equipmenteditor_name_global_limited = "全域限量"
L.equipmenteditor_desc_global_limited = "如果啟用，則該裝備只能在回合中購買一次。"
...
L.equipmenteditor_name_min_players = "購買該裝備時最低玩家數"
L.equipmenteditor_name_credits = "價格以積分計算"

-- 2021-06-08
L.equip_not_added = "未新增"
L.equip_added = "已新增"
L.equip_inherit_added = "已新增（繼承）"
...
L.header_rolelayering_info = "角色分層資訊"
L.help_rolelayering_roleselection = "角色選擇過程被分成兩個階段。在第一輪中，基礎角色被指派。基本角色是無辜者、叛徒和那些列在「基本角色層」框中的角色。第二遍是 用來將這些基礎角色升級為子角色。"
L.help_rolelayering_layers = "每個層中只有一個角色被選中。首先，來自自訂層的角色從第一層開始分配，直到到達最後一層或沒有更多的角色可以被升級。無論哪種情況先 發生。如果可升級的插槽仍然可用，未分層的角色也將被分配。"
L.scoreboard_voice_tooltip = "滾動以改變音量"

-- 2021-06-15
L.header_shop_linker = "設定"
L.label_shop_linker_set = "商店的設定"

-- 2021-06-18
L.xfer_team_indicator = "陣營"

-- 2021-06-25
L.searchbar_default_placeholder = "在清單中搜尋..."

-- 2021-07-11
L.spec_about_to_revive = "在復活時，觀察將被限制。"
...
L.spawneditor_ammo_edit = "按住編輯武器生成時自動產生的彈藥數量。"
...
L.spawn_weapon_edit_ammo = "按住 [{walkkey}]並按 [{primaryfire} 或 {secondaryfire}] 以增加或減少此武器產生的彈藥量"

L.spawn_type_weapon = "這是個武器生成點"
L.spawn_type_ammo = "這是個彈藥生成點"
L.spawn_type_player = "這是個玩家生成點"

L.spawn_remove = "按 [{secondaryfire}] 刪除此產生點"

L.submenu_administration_entspawn_title = "生成點編輯器"
L.header_entspawn_settings = "生成點編輯器設定"
L.button_start_entspawn_edit = "開始產生點編輯"
L.button_delete_all_spawns = "刪除所有生成點位置"

L.label_dynamic_spawns_enable = "為此地圖啟用動態生成"
L.label_dynamic_spawns_global_enable = "為所有地圖啟用自訂生成"

L.header_equipment_weapon_spawn_setup = "武器生成設定"

L.help_spawn_editor_info = [[
生成編輯器是用來放置，移除和編輯世界上的生成點。 這些生成點是為武器，彈藥和玩家準備的。

這些生成點被保存在位於"data/ttt/weaponspawnscripts/"的檔案中。 它們可以被刪除以進行硬重置。 最初的生成檔案是由地圖上和原始TTT武器生成腳本中的生成創建的。 按下重置按鈕總是會恢復到這個狀態。

應該注意的是，這個生成系統使用動態生成。 這將使武器生成系統更加有趣，因為它不再定義一個特定的武器。 而是定義一種武器類型。 例如，現在不是生成TTT自帶的霰彈槍，而是生成被分類成霰彈槍的武器，任何定義為霰彈槍的武器都可以生成。 每個武器的生成類型可以在裝備編輯器中設置，這使得任何武器都可以在地圖上生成，或停用某些預設武器。

請記住，更改只有在新的一輪開始後才會生效。 ]]
L.help_spawn_editor_enable = "在某些地圖上，可能會建議使用在地圖自帶的原始生成點，而不用動態系統來取代它們。禁用這個複選框只對當前活動地圖禁用。其他地圖仍將使用動態 系統。"
L.help_spawn_editor_hint = "提示：要離開生成編輯器，重新開啟遊戲模式選單。"
...
TTT2的生成系統允許每種武器在世界中生成，預設情況下，只有被創造者標記為'自動生成'的武器才會在世界中生成，但這些設定可以在該選單中更改。

大多數裝備在預設情況下被設定為'特殊武器生成'。 這意味著它們只在隨機武器生成點上產生。 然而，我們可以在地圖中放置特殊的武器生成點，或改變生成點的生成類型，以使用其他現有的生成類型。 ]]

L.pickup_error_inv_cached = "你現在不能拿起這個，因為你的庫存被緩存了。"

-- 2021-09-02
L.submenu_administration_playermodels_title = "玩家模型"
L.header_playermodels_general = "通用玩家模型設定"
L.header_playermodels_selection = "選擇玩家模型庫"

L.label_enforce_playermodel = "強制設定玩家模型"
L.label_use_custom_models = "使用一個隨機選擇的玩家模型"
L.label_prefer_map_models = "優先選擇地圖特定模型而非預設模型"
L.label_select_model_per_round = "每輪選擇新的隨機模型（如果停用，則僅在地圖變更時）"

L.help_prefer_map_models = [[
有些地圖定義了自己的玩家模型，預設情況下。 這些模型的優先權比自動分配的模型高。 如果停用此設定。 地圖自備的玩家模型將被停用，

角色的特定模型總是有更高的優先權。 不受這個設定的影響。 ]]
L.help_enforce_playermodel = [[
有些角色有自訂的玩家模型。 但是它可以被停用，可能會導致玩家模型選擇器的相容出現問題。
如果這個設定被停用，仍然可以選擇預設的隨機模型。 ]]
L.help_use_custom_models = [[
預設情況下，只有CS起源版鳳凰戰士的模型被分配給所有玩家，然而，如果啟用此選項，將使用玩家模型庫，啟用此設定後，每個玩家將被分配到相同的玩家模型，但這些 模型將從模型庫中選擇。

模型選擇可透過安裝更多的玩家模型來擴展。 ]]

-- 2021-10-06
L.menu_server_addons_title = "伺服器外掛"
L.menu_server_addons_description = "伺服器端管理員專用的外掛程式設定。"
...
左鍵點擊模型，將其新增至玩家模型庫。 再次以左鍵刪除它們。 右鍵可在所關注的模型的啟用和停用偵探帽之間進行切換。

左上角的小指示器顯示玩家模型是否有頭部的命中箱，下面的圖示顯示了這個模型是否可佩戴偵探帽。 ]]

L.menu_roles_title = "角色設定"
L.menu_roles_description = "設定生成機率、裝備積分及更多。"

L.submenu_administration_roles_general_title = "通用角色設定"

L.header_roles_info = "角色資訊"
L.header_roles_selection = "角色選擇機率"
L.header_roles_tbuttons = "角色叛徒按鈕"
L.header_roles_credits = "角色裝備積分"
L.header_roles_additional = "附加角色設定"
L.header_roles_reward_credits = "獎勵裝備積分"

L.help_roles_default_team = "預設團隊：{team}"
L.help_roles_unselectable = "這個角色是不可選擇的。這意味著它在角色選擇系統中不被考慮。大多數情況下，這意味著這是回合中通過某個事件（如復活為殭屍，副手老鷹或 類似的東西）手動應用的角色。"
L.help_roles_selectable = "這個角色是可選擇的，這意味著如果滿足所有的標準，這個角色在角色選擇過程中會被考慮。"
L.help_roles_credits = "裝備積分用於在商店購買裝備。大多數情況下，只給那些可以進入商店的角色信用額度是有意義的。然而，由於可從屍體上偷取積分，也可以考慮給角色 提供起始積分，作為給加害者的獎勵。"
L.help_roles_selection_short = "每個玩家的角色分佈定義了被分配到這個角色的玩家的百分比。例如，如果該值被設定為'0.2'，那麼每五名玩家中就有一人會變成這個角色。 "
L.help_roles_selection = [[
每個玩家的角色分配定義了被分配到這個角色的玩家的百分比。 例如，如果該值被設定為 "0.2"，那麼每五個玩家就會得到這個角色。 這也意味著，至少需要5名玩家才能被分配到這個角色。
請記住，所有這些都只適用於該角色被考慮分配過程。

前面提到的角色分配與玩家的下限有一個特殊的整合。 如果該角色被考慮用於分配，且最小值低於分配係數所給的值，但玩家數量等於或大於下限，則單一玩家仍可獲得該角色。 然後分配過程對第二個玩家照常進行。 ]]
L.help_roles_award_info = "部分角色（如果在他們的積分設定中啟用）在一定比例的對手死亡後會獲得裝備積分，該數值可在這裡進行調整。"
L.help_roles_award_pct = "當這個百分比的敵人死亡後，特定的角色會獲得分數。"
L.help_roles_award_repeat = "積分獎勵是否會多次發放。例如，如果你將百分比設為'0.25'，並啟用此功能，玩家將在死亡人數到達全玩家的'25%'，'50%'和' 75%'時獲得積分。"
L.help_roles_advanced_warning = "警告：這些是高級設置，可以完全擾亂角色分配過程。如果有疑問，請將所有值保持在'0'。這個值意味著不應用任何限制，角色分配將嘗試分配盡可能多 的角色。"
L.help_roles_max_roles = [[
角色類別包含TTT2中的每個角色。 預設情況下，對於可以分配多少個不同的角色沒有限制。 然而，這裡有兩種不同的方法來限制它們。

1.用一個固定的數值限制。
2.通過百分比限制。

後者僅在固定數值為'0'時使用，並根據設定的可用玩家百分比設定上限。 ]]
L.help_roles_max_baseroles = [[
基礎角色只是那些其他角色所繼承的角色陣營。 例如，"無辜者"角色是一個基礎角色，而"法老"是這個角色的一個子角色。 預設情況下，對於可以分配多少個不同的角色沒有限制。 然而，這裡有兩種不同的方法來限制它們。

1.用一個固定的數值限制。
2.通過百分比限制。

後者只在固定數值為'0'時使用，並根據設定的可用玩家百分比設定上限。 ]]

L.label_roles_enabled = "啟用角色"
L.label_roles_min_inno_pct = "每位玩家所指派的無辜者角色比例"
L.label_roles_pct = "每位玩家的角色分配"
L.label_roles_max = "被指派到該角色的玩家上限"
L.label_roles_random = "指派到該角色的可能性"
L.label_roles_min_players = "指派到該角色的最低下限"
...
L.label_roles_newroles_enabled = "啟用自訂角色"
L.label_roles_max_roles = "角色上限"
L.label_roles_max_roles_pct = "以百分比計算角色上限"
L.label_roles_max_baseroles = "基礎角色上限"
L.label_roles_max_baseroles_pct = "以百分比計算基礎角色上限"
L.label_detective_hats = "為像偵探這樣的警察角色啟用帽子（如果玩家模型允許戴帽子）。"

L.ttt2_desc_innocent = "無辜者沒有特殊能力。他們必須在恐怖分子中找到邪惡的人並殺死他們。但他們必須小心，不要誤殺自己的同伴。"
L.ttt2_desc_traitor = "叛徒是無辜者的敵人。他們有一個裝備選單，可以購買特殊裝備。他們必須殺死所有的人，除了他們的隊友。"
...
-- 2021-10-13
L.help_roles_credits_award_kill = "另一種獲得積分的方式是透過殺死為'公開角色'（如偵探）的高價值玩家。如果非無辜者陣營的角色啟用了這個功能，他們就會獲得以下規定的積分 。"
...
請注意，，即使全隊都會獲得獎勵，這仍然可以為每個角色啟用/停用。 例如，如果'無辜者'陣營被獎勵，但無辜者角色的裝備商店被禁用，所以只有偵探會收到積分。
這個功能的平衡值可以在'管理'->'通用角色設定'中設定。 ]]
L.help_detective_hats = [[
偵探等警察角色可以戴帽子以顯示其權威。 他們在死亡時或頭部受損時將失去帽子。

部分玩家模型預設不支援帽子。 你可以在'管理'->'玩家模型'中改變這一點。 ]]
...
L.submenu_administration_voicechat_title = "語音聊天/文字聊天"
L.submenu_administration_round_setup_title = "回合設定"
...
L.header_equipment_additional = "額外裝備設定"
L.header_administration_general = "通用管理設定"
L.header_administration_logging = "日誌"
L.header_administration_misc = "雜項"
L.header_entspawn_plyspawn = "玩家生成設定"
L.header_voicechat_general = "通用語音聊天設定"
L.header_voicechat_battery = "語音聊天電池"
L.header_voicechat_locational = "基於玩家位置範圍語音"
L.header_playersettings_plyspawn = "玩家生成設定"
...
L.header_textchat = "文字聊天"
L.header_round_dead_players = "死亡玩家設定"
L.header_administration_scoreboard = "記分版設定"
L.header_hud_toggleable = "可切換的HUD元素"
L.header_mapentities_prop_possession = "Prop附身"
L.header_mapentities_doors = "門"
L.header_karma_tweaking = "人品值調整"
L.header_karma_kick = "人品值踢出與封鎖"
L.header_karma_logging = "人品值記錄"
L.header_inventory_gernal = "庫存大小"
L.header_inventory_pickup = "庫存武器擷取"
L.header_sprint_general = "衝刺設定"
L.header_playersettings_armor = "護甲系統設定"

L.help_killer_dna_range = "當玩家被其他玩家殺死時，會在他們身上留下DNA指紋，最大範圍convar定義了留下DNA樣本的最大距離，以錘子編輯器為單位，如果殺手在更遠的地方 ，那麼就不會在屍體上留下樣本。"
L.help_killer_dna_basetime = "直到DNA樣本衰減的基本時間，以秒為單位，從這個基準時間減去一個殺手距離的平方係數。"
L.help_dna_radar = "如果配備了TTT2 DNA掃描器，會顯示所選DNA樣本的確切距離和方向。然而，也有一種經典的DNA掃描器模式，每次冷卻時間過後都會用世界範圍的渲染來更新 所選的樣本。"
L.help_idle = "掛機模式是用來將掛機的玩家轉移到一個強制的旁觀者模式。要再次離開這個模式，他們必須在他們的'遊戲'設定中禁用'強制旁觀者模式'。"
L.help_namechange_kick = [[
如果玩家在回合中改變他們的名字，這可能會被濫用來提供資訊。 因此，禁止在進行中的回合改變暱稱。

如果被封鎖時間大於0，則該玩家將無法重新連線到伺服器，直到該時間結束。 ]]
L.help_damage_log = "每次玩家受到傷害時，就會在控制台中新增一個傷害日誌條目。這也可以在一個回合結束後儲存到磁碟上。該檔案位於'data/terrortown/logs/'"
L.help_spawn_waves = [[
如果這個變數被設定為0，所有玩家將會同時產生。 對於擁有大量玩家的伺服器來說，一波一波地產生玩家可能是有益的。 生成波的時間間隔是指每個生成波之間的時間，一個生成波總是產生與會產生與生成點相同數量的玩家。

注意：確保準備時間足夠長，以達到所需的生成波數量。 ]]
L.help_voicechat_battery = [[
在啟用語音聊天電池的情況下，語音聊天會減少電力。 當電量耗盡時，玩家將不能語音聊天。 必須等待幾秒鐘來充電。 這可以幫助防止過度使用語音聊天。

注意：'Tick'指的是遊戲中的Tick，即1/66秒的時間。 ]]
L.help_ply_spawn = "在玩家（重新）產生時使用的玩家設定。"
L.help_haste_mode = [[
急速模式透過增加在玩家死亡時增加回合時間來平衡遊戲。 只有看到回合中失蹤的玩家的角色才能看到真正的回合時間，其他角色只能看到急速模式的起始時間。

如果急速模式被啟用，固定的回合時間將被忽略。 ]]
L.help_round_limit = "在滿足設定的限制條件之一後，將會更換地圖。"
L.help_armor_balancing = "以下數值可用來平衡護甲。"
L.help_item_armor_classic = "如果啟用了經典護甲模式，只有之前的設定才是生效的。經典護甲模式意味著玩家在一個回合中只能購買一次護甲，並且這個盔甲可以阻擋30%的子彈和 撬棍的傷害，直到他們死亡。"
L.help_item_armor_dynamic = [[
動態護甲是TTT2的新系統，讓護甲系統更加有趣。 現在可以購買的護甲數量是無限的，而且護甲的效果可以疊加。 受到傷害會降低護甲值，每件物品的護甲值是在該物品的"裝備設定"中設定的。

當受到傷害時。 這個傷害的一定比例會轉化為護甲傷害，不同的比例仍然適用於玩家，其餘的則會消失。
...
觀察者可以使用道具附身來附身於躺在世界中的道具，並使用緩慢充能的'飛擊量表'來移動上述道具。

'飛擊量表'的最大值由一個基礎值和其他判斷值組成，其中擊殺數/死亡數將影響該值。 隨著時間的推移，能量條會慢慢充電。 設定的充電時間是為'飛擊量表'中的一個點充電所需的時間。 ]]
L.help_karma = "玩家有一定量的初始人品值，傷害/殺死隊友時會失去人品。失去的數值取決於他們傷害或殺死的人的人品值，對方人品越低，損失的 人品越低。"
L.help_karma_strict = "如果嚴格人品模式被啟用，傷害懲罰會隨著人品值的減少快速增加。非嚴格模式下，人品值保持在800 以上時的傷害懲罰非常低。啟用嚴格模式使人 品值在阻止任何不必要的擊殺方面發揮更大的作用，而禁用它則導致一個更寬鬆的遊戲範圍，人品系統只會影響不斷擊殺隊友的玩家。"
L.help_karma_max = "將最大人品值設為1000以上，不會給人品值超過1000的玩家提供傷害加成，它可以作為一個人品值緩衝區。"
L.help_karma_ratio = "用於計算如果雙方在同一個團隊中，受害者的人品值被減去多少的傷害比例。如果發生擊殺友軍事件，會有進一步的懲罰。"
L.help_karma_traitordmg_ratio = "如果雙方在不同的隊伍中，用來計算受害者的人品值被減去多少的傷害比率。如果發生擊殺事件，會有進一步的獎勵。"
L.help_karma_bonus = "在一個回合中也有兩種不同的被動方式來獲得人品值。首先，一個回合的回復會應用於每個玩家。然後，如果沒有傷害隊友或擊殺，會有一個二次 回复的獎勵。"
L.help_karma_clean_half = [[
當玩家的人品值高於起始水平時（意味著人品值最大值已被配置為高於該水平），他們所有的人品值增加將根據其人品值高於起始水平的程度 而減少。 因此，它越高，增加的速度就越慢。

這種減少是以指數衰減的曲線進行的：最初速度很快，隨著增量的變小，速度也會變慢。 這個控制台指令設定了獎金減半的時間點（即半衰期）。 在預設值為0.25的情況下，如果人品值的起始值為1000，最大值為1500，而玩家有1125（1500-1000）*0.25=125)人品值，那麼他的無誤殺輪獎勵 將是30/2=15。 因此，為了使值下降得更快，你應該把該設定得更低，為了使它下降得更慢，你應該把它增加到1。 ]]
L.help_max_slots = "設定每個插槽的最大武器數量。'-1'表示沒有限制。"
L.help_item_armor_value = "這是動態模式下的護甲項目給出的護甲值。如果啟用了經典模式（請參閱'管理'->'玩家設定'），那麼每一個大於0的值都算是 護甲。"
...
L.label_dna_radar_cooldown = "DNA掃描器的冷卻時間"
L.label_radar_charge_time = "雷達取樣後的充電時間"
L.label_crowbar_shove_delay = "撬棍推玩家後的冷卻時間"
L.label_idle = "啟用掛機模式"
L.label_idle_limit = "最長可掛機時間（秒）"
L.label_namechange_kick = "啟用改名踢出"
L.label_namechange_bantime = "踢出後封禁的時間，以分鐘為單位"
L.label_log_damage_for_console = "啟用控制台的傷害記錄"
L.label_damagelog_save = "將傷害日誌儲存到磁碟上"
L.label_debug_preventwin = "停用回合結束[debug]"
L.label_bots_are_spectators = "機器人永遠是觀察者"
L.label_tbutton_admin_show = "向管理者顯示叛徒按鈕"
...
L.label_teleport_telefrags = "在傳送時殺死被封鎖的玩家"
L.label_allow_discomb_jump = "允許手榴彈發射器進行迪斯可跳躍"
L.label_spawn_wave_interval = "產生的間隔時間，以秒為單位"
L.label_voice_enable = "啟用語音聊天"
L.label_voice_drain = "啟用語音聊天的電池功能"
L.label_voice_drain_normal = "一般玩家的每個滴答消耗量"
L.label_voice_drain_admin = "讓管理者和公共警察角色的電池會耗盡"
L.label_voice_drain_recharge = "不進行語音聊天時每滴答的充能率"
L.label_locational_voice = "為活著的玩家啟用近距離語音聊天功能"
L.label_armor_on_spawn = "玩家在重生時的預設護甲量"
...
L.label_lastwords_chatprint = "如果打字時被殺，則發出最後一句話至聊天室"
...
L.label_highlight_admins = "突出伺服器管理員"
L.label_highlight_dev = "突出顯示TTT2開發者"
L.label_highlight_vip = "突出TTT2支持者"
L.label_highlight_addondev = "突出顯示TTT2附加元件的開發者"
L.label_highlight_supporter = "突出顯示其他人"
L.label_enable_hud_element = "啟用{elem}HUD元素"
L.label_spec_prop_control = "啟用Prop附身"
L.label_spec_prop_base = "附體時的基礎值"
L.label_spec_prop_maxpenalty = "降低附身獎金下限"
L.label_spec_prop_maxbonus = "提高附身獎金上限"
L.label_spec_prop_force = "附身時推動力"
L.label_spec_prop_rechargetime = "充能時間（秒）"
L.label_doors_force_pairs = "強迫讓只能關上的門變成正常門"
L.label_doors_destructible = "啟用破壞閘系統"
...
L.label_karma_clean_half = "無誤殺獎勵減少比"
L.label_karma_persist = "人品值在地圖更換後仍保留"
L.label_karma_low_autokick = "自動踢掉低人品值的玩家"
L.label_karma_low_amount = "低人品值閾值"
L.label_karma_low_ban = "封禁選取的最低人品值玩家"
L.label_karma_low_ban_minutes = "封鎖時間（分鐘）"
L.label_karma_debugspam = "啟用關於人品值變化的偵錯輸出到控制台"
L.label_max_melee_slots = "近戰槽位最多可攜帶"
L.label_max_secondary_slots = "輔助插槽最多可攜帶"
L.label_max_primary_slots = "主要插槽最多可攜帶"
L.label_max_nade_slots = "最大手榴彈插槽"
L.label_max_carry_slots = "攜帶插槽最多可攜帶"
L.label_max_unarmed_slots = "非武裝插槽最多可攜帶"
L.label_max_special_slots = "特殊插槽最多可攜帶"
L.label_max_extra_slots = "額外插槽最多可攜帶"
L.label_weapon_autopickup = "啟用自動武器拾取"
L.label_sprint_enabled = "啟用衝刺功能"
L.label_sprint_max = "衝刺體力最大值"
L.label_sprint_stamina_consumption = "體力消耗係數"
L.label_sprint_stamina_regeneration = "體力復原係數"
L.label_sprint_crosshair = "衝刺時顯示準星"
L.label_crowbar_unlocks = "主要攻擊鍵可以作為互動（即解鎖）使用"
L.label_crowbar_pushforce = "撬棍推力"

-- 2022-07-02
L.header_playersettings_falldmg = "跌倒傷害設定"

L.label_falldmg_enable = "啟用跌倒傷害"
L.label_falldmg_min_velocity = "發生跌倒傷害的最小速度閾值"
L.label_falldmg_exponent = "與速度相關的跌倒傷害增加指數"

L.help_falldmg_exponent = [[
該值修改了隨著玩家撞擊地面的速度而以指數方式增加的跌倒傷害。

更改此值時請小心。 設定得太高，即使是二階梯的高度也會致命，而設定得太低，玩家從五樓跳下來時也安然無恙。 ]]

-- 2023-02-08
L.testpopup_title = "一個測試彈出窗口，現在有一個多行標題，多好啊！"
L.testpopup_subtitle = "好吧，你好！這是一個帶有一些特殊信息的花式彈出窗口。文字也可以是多行的，多好啊！呃，如果我有什麼想法的話，我可以添加這麼 多的文字..."

L.hudeditor_chat_hint1 = "[TTT2][INFO] 將滑鼠懸停在一個元素上，按住[LMB]並移動滑鼠來移動或調整其大小。"
...
L.guide_nothing_desc = "這是一項正在進行中的工作，透過在GitHub上為專案做出貢獻來幫助我們。"

L.sb_rank_tooltip_developer = "TTT2開發者"
L.sb_rank_tooltip_vip = "TTT2支持者"
L.sb_rank_tooltip_addondev = "TTT2附加元件開發者"
L.sb_rank_tooltip_admin = "伺服器管理員"
...
L.equipmenteditor_desc_drop_on_death_type = "嘗試覆寫玩家死亡時裝備是否被丟棄的動作。"

L.drop_on_death_type_default = "預設（由武器定義）"
...
L.label_voice_scaling_mode_log = "對數"
