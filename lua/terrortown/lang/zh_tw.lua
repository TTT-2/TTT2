...
L.win_nones = "無人勝出！（平局）"
L.win_showreport = "來看一下 {num} 秒的回合總結吧！"
...
L.karma_dmg_other = "你的人品為 {amount}，因此本回合你造成的傷害將減少 {num}%"
...
L.body_call = "{player} 請求探長前來檢查 {victim} 的屍體！"
L.body_call_error = "你必須先確定該玩家的死才能呼叫探長！"

L.body_burning = "好燙！這個屍體着火了！"
...
L.disg_help1 = "偽裝開啓後，別人瞄準你時將不會看見你的名字，生命以及人品。除此之外，你也能躲避探長的雷達。"
L.disg_help2 = "可直接在主選單外，使用數字鍵來切換偽裝。你也可以用控制枱指令綁定指令 ttt_toggle_disguise。"
...
L.radar_scan = "執行掃描"
L.radar_auto = "自動重複掃描"
L.radar_help = "掃描結果將顯示 {num} 秒，接着雷達充電後你便可以再次使用。"
L.radar_charging = "你的雷達還在充電中！"
...
L.xfer_received = "{player} 給予你 {num} 積分。"
...
L.intro_help = "若你是該模式的新手，請按下F1查看模式教程！"
...
L.search_armor = "他穿着非標準裝甲。"
L.search_disg = "他持有一個能隱匿身份的設備"
L.search_radar = "他持有像是雷達的裝備，已經無法使用了。"
L.search_c4 = "你在他口袋中找到了一本筆記。記載着第 {num} 根線才能解除炸彈。"
...
L.search_time = "他大約在你搜索前的 {time} 死亡。"
L.search_dna = "用DNA掃描器檢索兇手的DNA標本，DNA樣本大約在 {time} 前開始衰退。"

L.search_kills1 = "你找到一個名單，記載着他發現的死者： {player}"
L.search_kills2 = "你找到了一個名單，記載着他殺的這些人："
L.search_eyes = "透過你的探查技能，你確信他臨死前見到的最後一個人是 {player}。兇手，還是巧合？"

-- Scoreboard
L.sb_playing = "你正在玩的服務器是..."
...
L.item_armor = "護甲"
L.item_armor_desc = [[
阻擋子彈，火焰和爆炸傷害。耐久會隨着使用而降低。

這個裝備可以購買多次。護甲達到一定閾值後防御力會上升。]]

L.item_radar = "雷達"
L.item_radar_desc = [[
允許你掃描存活着的玩家。

一旦持有，雷達會開始自動掃描。使用該頁面的雷達菜單來設置。]]

L.item_disg = "偽裝"
L.item_disg_desc = [[
啓用時，你的ID將被隱藏；也可避免探長在屍體上找到死者生前見到的最後一個人。

需要啓用時，使用本頁面的偽裝菜單或按下小鍵盤回️車鍵。]]

-- C4
L.c4_hint = "按下 {usekey} 來安放或拆除C4。"
...
L.c4_remove_destroy1 = "銷燬C4"
L.c4_remove_destroy2 = "確認：銷燬"

L.c4_disarm = "拆除C4"
L.c4_disarm_cut = "點擊以剪斷 {num} 號引線"

L.c4_disarm_t     = "剪斷引線以拆除C4。你是叛徒，因此每條引線都是安全的，但其他人可就沒那麼容易了！"
L.c4_disarm_owned = "剪斷引線以拆除C4。你是安放此C4的人，任何引線都能成功拆除。"
...
L.hstation_help = "{primaryfire} 安放了一個醫療站。"

L.hstation_desc = [[
安放後，允許人們用其治療自己。

充能速度相當緩慢。所有人都可以使用，而且醫療站可以受到傷害。每位使用者會留下可採集的DNA樣本。]]
...
-- Poltergeist
L.polter_desc = [[
放置震動器在物體上，使它們危險地四處飛動。

能量爆炸會使附近的人受到傷害。]]

-- Radio
L.radio_broken = "你的收音機已被摧毀！"
L.radio_help_pri = "{primaryfire} 安放了收音機。"

L.radio_desc = [[
播放音效來誤導或欺騙玩家。

將收音機安放下來，然後用該頁面的收音機菜單播放。]]
...
L.dna_limit = "已達最大采集額度，請先移除舊樣本。"
L.dna_decayed = "兇手的DNA樣本已經消失。"
L.dna_killer = "成功採集到兇手的DNA樣本！"
L.dna_duplicate = "匹配！你的掃描儀裏已經有這個DNA樣本了。"
L.dna_no_killer = "DNA樣本無法檢索（兇手已離線？）"
L.dna_armed = "炸彈已啓動！趕緊拆除它！"
...
-- Magneto stick
L.magnet_name = "電磁棍"
L.magnet_help = "{primaryfire} 將其定在牆上。"
...
L.target_credits = "搜索屍體以獲取未被消耗積分"

-- HUD buttons with hand icons that only traitors can see
L.tbut_single = "一次性"
L.tbut_reuse = "重複使用"
L.tbut_retime = "{num} 秒可後再次使用"
...
-- Tip texts
L.tip1 = "叛徒不用確認其死亡即可悄悄檢查屍體，只需對着屍體按着 {walkkey} 鍵後再按 {usekey} 鍵即可。"

L.tip2 = "將C4爆炸時間設置更長，可增加引線數量，使拆彈者失敗可的能性大幅上升，且能讓C4的嗶嗶聲更輕更慢。"

L.tip3 = "探長能在屍體查出誰是\"死者最後看見的人\"。若是遭到背後攻擊，最後看見的將不會是兇手。"

L.tip4 = "被你的屍體被發現並確認之前，沒人知道你已經死亡。"

L.tip5 = "叛徒殺死探長時會立即得到一點積分。"

L.tip6 = "一名叛徒死後，探長將得到一點積分作為獎勵。"

L.tip7 = "叛徒殺害一定數量的無辜者後，全體都會獲得一點積分作為獎勵。"

L.tip8 = "叛徒和探長能從同伴屍體上取得未被消耗的積分。"

L.tip9 = "促狹鬼將使物體變得極其危險。促狹鬼調整過的物體將產生爆炸能量傷害接近它的人。"

L.tip10 = "叛徒與探長應保持注意屏幕右上方的紅色信息，這對你無比重要。"

L.tip11 = "叛徒或探長和同伴配合得好時會獲得額外積分。請善用這些積分！"
...
L.tip16 = "作為叛徒，傳送器可幫助你逃脱追蹤，並讓你得以迅速穿過整個地圖。請隨時確保有個安全的傳送標記。"

L.tip17 = "是否遇過無辜者羣聚在一起而難以下手？請試試用收音機發出C4嗶嗶聲或交火聲，讓他們分散。"
...
L.tip24 = "按下 {helpkey} 閲讀教學或變更設定，比如説，你可以永遠關掉現在所看到的提示唷～"

L.tip25 = "探長確認屍體後，相關信息將在計分板公布，如要查看只需點擊死者之名字即可。"

L.tip26 = "計分板上，人物名字旁的放大鏡圖樣可以查看關於他的信息，若圖樣亮着，代表是某位探長確認後的結果。"

L.tip27 = "探長調查屍體後的結果將公佈在計分板，供所有玩家查看。"

L.tip28 = "觀察者可以按下 {mutekey} 循環調整對其他觀察者或遊戲中的玩家靜音。"

L.tip29 = "若服務器有安裝其他語言，你可以在任何時間開啓F1選單，啓用不同語言。"

L.tip30 = "若要使用語音或無線電，可以按下 {zoomkey} 使用。"

L.tip31 = "作為觀察者，按下 {duckkey} 能固定視角並在遊戲內移動光標，可以點擊提示欄裏的按鈕。此外，再次按下 {duckkey} 會解除並恢復默認視角控制。"
...
L.tip36 = "按下 {helpkey} 可以觀看教學，其中包含了重要的遊戲信息。"
...
L.tip40 = "若時間上顯示\"急速模式\"，此回合的時間會很短，但每位玩家的死亡都將延長時間（就像TF2的佔點模式）。延長時間將迫使叛徒加緊腳步。"
...
L.report_tab_scores_tip = "本回合單個玩家獲得的分數"

-- Event log saving
L.report_save = "保存 Log.txt"
L.report_save_tip = "將事件記錄並保存在txt檔內"
L.report_save_error = "沒有可供保存的事件記錄"
...
L.aw_sui2_text = "就他一人自殺，無比哀慼。"

L.aw_exp1_title = "炸彈研究的第一把交椅"
L.aw_exp1_text = "決心研究C4。{num} 名受試者證明了他的理論。"
...
L.aw_hed2_text = "近距離將 {num} 名玩家的腦袋取出，完成自己的腦神經研究。"

L.aw_hed3_title = "從遊戲裏學來的"
...
L.aw_pst2_text = "用手槍殺了 {num} 人的小隊。我們推測他槍管裏頭有個微型霰彈槍。"

L.aw_sgn1_title = "簡單模式"
L.aw_sgn1_text = "用霰彈槍近距離殺了 {num} 名玩家。切。"

L.aw_sgn2_title = "一千顆小彈丸"
L.aw_sgn2_text = "不喜歡自己的霰彈，打算送人。已經有 {num} 名受贈人接受了這個禮物。"

L.aw_rfl1_title = "把準心對準目標扣下扳機……"
L.aw_rfl1_text = "用一把好槍和一個沉穩的手終結了 {num} 名玩家的生命。"

L.aw_rfl2_title = "你的腦袋冒出來了！"
L.aw_rfl2_text = "十分了解他的狙擊槍，其他 {num} 名玩家隨即也瞭解了他的狙擊槍。"

L.aw_dgl1_title = "這簡直像是小型狙擊槍"
L.aw_dgl1_text = "用沙漠之鷹嫺熟地殺了 {num} 名玩家。"

L.aw_dgl2_title = "老鷹大師"
L.aw_dgl2_text = "用他手中的沙漠之鷹殺了 {num} 名玩家。"

L.aw_mac1_title = "按下扳機，然後祈禱"
...
L.aw_flg1_title = "買根煙嗎？"
L.aw_flg1_text = "用燃燒彈點燃了 {num} 人的香煙。"

L.aw_flg2_title = "火上澆油"
...
L.aw_hug2_text = "從未拋棄心愛的M249，最終用其殺戮了 {num} 名玩家。"

L.aw_msx1_title = "啪啪啪"
L.aw_msx1_text = "用M16步槍射殺了 {num} 名玩家。"

L.aw_msx2_title = "中距離瘋子"
L.aw_msx2_text = "瞭解如何用他手中的M16，射殺了敵人。共有 {num} 名不幸的亡魂。"
...
L.aw_tkl5_text = "在扮演一個瘋子，所以把自己大部分的同伴殺死了。"

L.aw_tkl6_title = "痛擊隊友"
L.aw_tkl6_text = "弄不清他屬於哪一隊，並殺死了半數以上的隊友。"

L.aw_tkl7_title = "園丁"
L.aw_tkl7_text = "好好保護着自己的草坪，並殺死了四分之一以上的隊友。"
...
L.reroll_no_credits = "你需要花費 {amount} 積分進行重選！"
L.reroll_button = "重選"
L.reroll_help = "使用 {amount} 積分在你的商店裏獲得新的隨機裝備！"
...
L.hud_forced_failed = "未能將界面 {hudname} 設為強制。你沒有權限，或這個界面不存在。"
L.hud_restricted_failed = "未能將界面 {hudname} 設為限制。你沒有權限，或這個界面不存在。"

L.shop_role_select = "選擇身份"
L.shop_role_selected = "選中了 {role} 的商店！"
L.shop_search = "搜索"

L.spec_help = "點擊來觀察玩家，或對着物理道具按 {usekey} 來附身。"
L.spec_help2 = "若想離開觀察者模式，用 {helpkey} 打開菜單，在“遊戲性”選項中勾選選項。"

-- 2019-10-19
L.drop_ammo_prevented = "有什麼東西阻擋你丟出子彈。"
...
L.menu_equipment_description = "設置裝備的價格，限制，可用性等"
...
L.help_color_desc = "此選項啓用後，準星和目標高亮的外框會顯示一個全局通用的顏色"
...
L.help_targetid_info = "目標高亮（TargetID）是顯示在實體和玩家下面的信息。可以在通用菜單啓用全局顏色。"
...
L.help_hud_enabled_desc = "啓用/禁用 HUD 來限制玩家選擇它們。"
...
L.label_global_color_enable = "啓用全局顏色"
...
L.label_shop_double_click_buy = "啓用來雙擊購買商店裝備"
...
L.label_crosshair_enable = "啓用十字準星"
L.label_crosshair_gap_enable = "啓用自定義準星大小"
...
L.label_crosshair_static_enable = "啓用靜態準星"
L.label_crosshair_dot_enable = "啓用準星中點"
L.label_crosshair_lines_enable = "啓用準星直線"
L.label_crosshair_scale_enable = "啓用武器對應準星大小"
L.label_crosshair_ironsight_low_enabled = "瞄準時降低武器模型"
L.label_damage_indicator_enable = "啓用傷害指示"
...
L.label_performance_spec_outline_enable = "啓用被附身物品的外框"
L.label_performance_ohicon_enable = "啓用頭上身份圖標"
L.label_interface_tips_enable = "啓用觀察時屏幕下方的遊戲提示"
L.label_interface_popup = "回合開始信息持續時間"
L.label_interface_fastsw_menu = "啓用快速切換菜單"
L.label_inferface_wswitch_hide_enable = "啓用武器菜單自動關閉"
L.label_inferface_scues_enable = "回合開始或結束時播放特定聲音"
L.label_gameplay_specmode = "觀察者模式（永遠觀察）"
L.label_gameplay_fastsw = "武器快速切換"
L.label_gameplay_hold_aim = "啓用持續瞄準"
L.label_gameplay_mute = "死亡時靜音存活玩家"
L.label_gameplay_dtsprint_enable = "啓用雙擊衝刺"
L.label_gameplay_dtsprint_anykey = "衝刺時任何方向鍵都持續衝刺"
...
L.label_menu_not_populated = "這個子菜單什麼都沒有。"
...
L.header_roleselection = "啓用身份分配"
L.header_hud_administration = "選擇默認和強制 HUD"
L.header_hud_enabled = "啓用/禁用 HUDs"
...
L.corpse_hint_inspect_only_credits = "按 [{usekey}] 獲取積分。只有偵探能確認死亡。"
...
L.shopeditor_name_random_shops = "啓用隨機商店"
...
L.shopeditor_name_random_team_shops = "啓用陣營商店"
L.shopeditor_name_random_shop_reroll = "啓用商店重選功能"
...
L.equipmenteditor_desc_not_random = "如果啓用，該裝備在商店中始終可用。當隨機商店被啓用時，它會佔用一個可用的隨機槽，並總是為這個裝備保留它。"
L.equipmenteditor_name_global_limited = "全侷限量"
L.equipmenteditor_desc_global_limited = "如果啓用，該裝備只能在回合中購買一次。"
L.equipmenteditor_name_team_limited = "陣營限量"
L.equipmenteditor_desc_team_limited = "如果啓用，該裝備在回合中每個陣營只能購買一次。"
L.equipmenteditor_name_player_limited = "玩家限量"
L.equipmenteditor_desc_player_limited = "如果啓用，每個玩家在回合中只能購買一次。"
...
L.label_dynamic_spawns_enable = "為該地圖啓用動態生成"
L.label_dynamic_spawns_global_enable = "為所有地圖啓用自定義生成"
...
大多數裝備在默認情況下被設置為'特殊武器生成'。這意味着它們只在隨機武器生成點上生成。然而，我們可以在地圖中放置特殊的武器生成點，或者改變生成點的生成類型，以使用其他現有的生成類型。]]
...
L.label_enforce_playermodel = "強制設置玩家模型"
...
默認情況下，只有CS起源版鳳凰戰士的模型被分配給所有玩家，然而，如果啓用這個選項，將使用玩家模型庫，啓用此設置後，每個玩家將被分配到相同的玩家模型，但這些模型將從模型庫中選擇。
...
左鍵點擊模型，將其添加到玩家模型庫中。再次以左鍵刪除它們。右鍵可在所關注的模型的啓用和禁用偵探帽之間進行切換。
...
L.help_roles_unselectable = "這個角色是不可選擇的。這意味着它在角色選擇系統中不被考慮。大多數情況下，這意味着這是回合中通過某個事件（如復活為殭屍，副手老鷹或類似的東西）手動應用的角色。"
L.help_roles_selectable = "這個角色是可選擇的，這意味着如果滿足所有的標準，這個角色在角色選擇過程中會被考慮。"
...
每個玩家的角色分配定義了被分配到這個角色的玩家的百分比。例如，如果該值被設置為 "0.2"，那麼每五個玩家就會得到這個角色。這也意味着，至少需要5名玩家才能分配到這個角色。
請記住，所有這些都只適用於該角色被考慮分配過程。

前面提到的角色分配與玩家的下限有一個特殊的整合。如果該角色被考慮用於分配，且最小值低於分配係數所給的值，但玩家數量等於或大於下限，則單個玩家仍可獲得該角色。然後分配過程對第二個玩家照常進行。]]
L.help_roles_award_info = "部分角色（如果在他們的積分設置中啓用）在一定比例的對手死亡後會獲得裝備積分，該數值可在這裏進行調整。"
L.help_roles_award_pct = "當這個百分比的敵人死亡後，特定的角色會獲得積分。"
L.help_roles_award_repeat = "積分獎勵是否會多次發放。例如，如果你將百分比設置為'0.25'，並啓用此功能，玩家將在死亡人數到達全玩家的'25%'，'50%'和'75%'時獲得積分。"
L.help_roles_advanced_warning = "警告：這些是高級設置，可以完全擾亂角色分配過程。如果有疑問，請將所有值保持在 '0'。這個值意味着不應用任何限制，角色分配將嘗試分配儘可能多的角色。"
L.help_roles_max_roles = [[
角色類別包含TTT2中的每個角色。默認情況下，對於可以分配多少個不同的角色沒有限制。然而，這裏有兩種不同的方法來限制它們。
...
基礎角色只是那些其他角色所繼承的角色陣營。例如，"無辜者"角色是一個基礎角色，而"法老"是這個角色的一個子角色。默認情況下，對於可以分配多少個不同的角色沒有限制。然而，這裏有兩種不同的方法來限制它們。
...
L.label_roles_newroles_enabled = "啓用自定義角色"
...
L.label_detective_hats = "為像偵探這樣的警察角色啓用帽子（如果玩家模型允許戴帽子）。"
...
-- 2021-10-13
L.help_roles_credits_award_kill = "另一種獲得積分的方式是通過殺死為'公開角色'（如偵探）的高價值玩家。如果非無辜者陣營的角色啓用了這個功能，他們就會獲得以下規定的積分。"
...
請注，，即使全隊都會獲得獎勵，這仍然可以為每個角色啓用/禁用。例如，如果'無辜者'陣營被獎勵，但無辜者角色的裝備商店被禁用，所以只有偵探會收到積分。
...
L.label_roles_credits_dead_award = "啓用對依據一定比例敵人死亡數提供積分獎勵"
L.label_roles_credits_kill_award = "啓用對擊殺高價值角色時提供積分獎勵"
...
L.help_idle = "掛機模式是用來將掛機的玩家轉移到一個強制的旁觀者模式。要再次離開這個模式，他們必須在他們的'遊戲'設置中禁用'強制旁觀模式'。"
L.help_namechange_kick = [[
如果玩家在回合中改變他們的名字，這可能會被濫用來提供信息。因此，禁止在進行中的回合改變暱稱。

如果被封禁時間大於0，該玩家將無法重新連接到服務器，直到該時間結束。]]
L.help_damage_log = "每次玩家受到傷害時，就會在控制枱中添加一個傷害日誌條目。這也可以在一個回合結束後存儲到磁盤上。該文件位於'data/terrortown/logs/'"
L.help_spawn_waves = [[
如果這個變量被設置為0，所有玩家將會同時生成。對於擁有大量玩家的服務器來説，一波一波地生成玩家可能是有益的。生成波的時間間隔是指每個生成波之間的時間，一個生成波總是產生與會生成與生成點相同數量的玩家。

注意：確保準備時間足夠長，以達到所需的生成波數量。]]
L.help_voicechat_battery = [[
在啓用語音聊天電池的情況下，語音聊天會減少電量。當電量耗盡時，玩家將不能語音聊天。必須等待幾秒鐘來充電。這可以幫助防止過度使用語音聊天。
...
如果急速模式被啓用，固定的回合時間將被忽略。]]
L.help_round_limit = "在滿足設定的限制條件之一後，將會更換地圖。"
L.help_armor_balancing = "以下數值可以用來平衡護甲。"
L.help_item_armor_classic = "如果啓用了經典護甲模式，只有之前的設置才是生效的。經典護甲模式意味着玩家在一個回合中只能購買一次護甲，並且這個盔甲可以阻擋30%的子彈和撬棍的傷害，直到他們死亡。"
...
如果強化護甲被啓用，只要護甲值高於強化閾值，施加給玩家的傷害就會減少15%。]]
L.help_sherlock_mode = "偵探模式是經典的TTT模式。如果偵探模式被禁用，屍體將被確認，記分牌上顯示每個人都活着，觀察者可以與活着的玩家交談。"
L.help_prop_possession = [[
觀察者可以使用道具附身來附身於躺在世界中的道具，並使用緩慢充能的'飛擊量表'來移動上述道具。

'飛擊量表'的最大值由一個基礎值和其他判斷值組成，其中擊殺數/死亡數將影響該值。隨着時間的推移，能量條會慢慢充電。設定的充電時間是為'飛擊量表'中的一個點進行充電所需的時間。]]
L.help_karma = "玩家有一定量的初始人品值，傷害/殺死隊友時會失去人品。失去的數值取決於他們傷害或殺死的人的人品值，對方人品越低，損失的人品越低。"
L.help_karma_strict = "如果嚴格人品模式被啓用，傷害懲罰會隨着人品值的減少快速增加。非嚴格模式下，人品值保持在 800 以上時的傷害懲罰非常低。啓用嚴格模式使人品值在阻止任何不必要的擊殺方面發揮更大的作用，而禁用它則導致一個更寬鬆的遊戲範圍，人品系統只會影響不斷擊殺隊友的玩家。"
...
L.help_karma_bonus = "在一個回合中也有兩種不同的被動方式來獲得人品值。首先，一個回合的回覆會應用於每個玩家。然後，如果沒有傷害隊友或擊殺，會有一個二次回覆的獎勵。"
L.help_karma_clean_half = [[
當玩家的人品值高於起始水平時（意味着人品值最大值已被配置為高於該水平），他們所有的人品值增加將根據其人品值高於起始水平的程度而減少。因此，它越高，增加的速度就越慢。

這種減少是以指數衰減的曲線進行的：最初速度很快，隨着增量的變小，速度也會變慢。這個控制枱指令設定了獎金減半的時間點（即半衰期）。在默認值為0.25的情況下，如果人品值的起始值為1000，最大值為1500，而玩家有1125（1500-1000）*0.25=125)人品值，那麼他的無誤殺輪獎勵將是30/2=15。因此，為了使值下降得更快，你應該把該設置得更低，為了使它下降得更慢，你應該把它增加到1。]]
L.help_max_slots = "設置每個插槽的最大武器數量。'-1'表示沒有限制。"
L.help_item_armor_value = "這是動態模式下的護甲項目給出的護甲值。如果啓用了經典模式（見'管理'->'玩家設置'），那麼每一個大於0的值都被算作護甲。"

L.label_killer_dna_range = "留下DNA的最大擊殺範圍"
L.label_killer_dna_basetime = "樣本存活基礎時間"
L.label_dna_scanner_slots = "DNA樣本插槽"
L.label_dna_radar = "啓用經典DNA掃描模式"
...
L.label_namechange_kick = "啓用改名踢出"
L.label_namechange_bantime = "踢出後封禁的時間，以分鐘為單位"
L.label_log_damage_for_console = "啓用控制枱的傷害記錄"
...
L.label_ragdoll_carrying = "啓用布娃娃搬運"
L.label_prop_throwing = "啓用道具投擲"
L.label_ragdoll_pinning = "為非無辜者角色啓用布娃娃夾子"
L.label_ragdoll_pinning_innocents = "為無辜者啓用布娃娃夾子"
L.label_weapon_carrying = "啓用武器搬運"
...
L.label_voice_enable = "啓用語音聊天"
L.label_voice_drain = "啓用語音聊天的電池功能"
...
L.label_postround_dm = "回合結束後啓用死亡競賽"
L.label_session_limits_enabled = "啓用地圖更換"
L.label_spectator_chat = "啓用觀察者與大家聊天的功能"
L.label_lastwords_chatprint = "如果在打字時被殺，則發出最後一句話至聊天室"
L.label_identify_body_woconfirm = "不按'確認'按鈕識別屍體"
L.label_announce_body_found = "宣佈發現了一具屍體"
L.label_confirm_killlist = "宣佈確認屍體時，該屍體的擊殺名單"
...
L.label_armor_block_headshots = "啓用護甲阻擋爆頭傷害"
L.label_armor_block_blastdmg = "啓用護甲阻擋爆炸傷害"
L.label_armor_dynamic = "啓用動態裝甲"
L.label_armor_value = "護甲物品所賦予的護甲"
L.label_armor_damage_block_pct = "護甲承受的傷害百分比"
L.label_armor_damage_health_pct = "玩家承受的傷害百分比"
L.label_armor_enable_reinforced = "啓用強化護甲"
L.label_armor_threshold_for_reinforced = "強化護甲閾值"
L.label_sherlock_mode = "啓用偵探模式"
...
L.label_enable_hud_element = "啓用{elem}HUD元素"
L.label_spec_prop_control = "啓用Prop附體"
...
L.label_doors_destructible = "啓用破壞門系統"
...
L.label_karma_debugspam = "啓用關於人品值變化的調試輸出到控制枱"
...
L.label_weapon_autopickup = "啓用自動武器拾取"
L.label_sprint_enabled = "啓用衝刺功能"
L.label_sprint_max = "衝刺體力最大值"
L.label_sprint_stamina_consumption = "體力消耗係數"
L.label_sprint_stamina_regeneration = "體力恢復係數"
...
L.guide_nothing_title = "這裏暫時什麼都沒有！"
...
L.equipmenteditor_desc_allow_drop = "如果啓用，玩家可以自由地丟棄裝備。"
