...
L.round_restart = "라운드가 관리자에 의해 강제로 재시작 되었습니다."
...
L.radio_name = "라디오"
L.radio_help = "버튼을 눌러 원하는 소리를 재생할 수 있습니다."
L.radio_notplaced = "사용 전 라디오를 설치해야 합니다."
...
-- Magneto stick
L.magnet_name = "자석봉"
L.magnet_help = "{primaryfire} 를 눌러 표면에 시체를 고정 시킬 수 있습니다."
...
L.tip40 = "만약 타이머에 'Haste Mode'라고 적혀있다면, 라운드가 그 시간 후에 끝난다는 소리입니다. 하지만 누군가 사망할 시 제한시간이 늘어납니다. (팀포 2의 오버타임처럼) 이를 이용하여 트레이터가 계속 움직이도록 할 수 있습니다."
...
--.hud_restricted_failed = "Failed to restrict the HUD {hudname}. You don't have permission to do that."
...
L.label_interface_tips_enable = "관전 중 화면 하단에 게임 피드백 표시"
...
L.marker_vision_distance = "거리: {distance}m"
...
L.beacon_pickup_disabled = "신호기의 주인만이 주울 수 있습니다"
