...
L.title_event_c4_plant = "Ein C4 wurde scharf gemacht"
...
L.desc_event_c4_disarm_success = "{disarmer} ({drole} / {dteam}) hat erfolgreich das C4 entschärft, welches von {owner} ({orole} / {oteam}) scharf gemacht wurde."
L.desc_event_c4_disarm_failed = "{disarmer} ({drole} / {dteam}) hat versucht, das C4 zu entschärfen, welches von {owner} ({orole} / {oteam}) scharf gemacht wurde. Der Versuch war nicht erfolgreich."
L.desc_event_c4_explode = "Das C4 von {owner} ({role} / {team}) explodierte."
L.desc_event_c4_plant = "{owner} ({role} / {team}) hat ein C4 scharf gemacht."
...
L.help_roles_credits = "Credits werden verwendet, um Ausrüstung im Shop zu kaufen. Es ergibt meistens Sinn, sie nur für die Rollen zu vergeben, die Zugang zu Shops haben. Da es jedoch möglich ist, Credits in Leichen zu finden, können Sie Rollen auch Startcredits als Belohnung für ihren Mörder geben."
...
L.submenu_administration_mapentities_title = "Karten Entities"
...
L.header_round_setup_map_duration = "Karten Session"
...
L.header_mapentities_prop_possession = "Prop Besitzergreifung"
...
Die Prop-Besitzung kann von Zuschauern verwendet werden, um im Spiel liegende Gegenstände zu besitzen und den langsam wieder aufladenden 'Schlagzähler' zu verwenden, um den genannten Gegenstand zu bewegen.

Der maximale Wert des 'Schlagzählers' setzt sich aus einem Grundwert für die Besitztum-Grundlage zusammen, zu dem die Differenz zwischen Kills und Toden zwischen zwei definierten Grenzen addiert wird. Der Zähler lädt sich im Laufe der Zeit langsam auf. Die eingestellte Aufladezeit ist die Zeit, die benötigt wird, um einen einzelnen Punkt im 'Schlagzähler' aufzuladen.]]
...
L.label_idle = "Aktiviere den Idle Modus"
L.label_idle_limit = "Maximale Idle Zeit in Sekunden"
...
L.label_session_limits_enabled = "Aktiviere Session Limitierungen"
...
L.label_spec_prop_control = "Aktiviere Prop Besitzergreifung"
L.label_spec_prop_base = "Besitzergreifung Basis"
L.label_spec_prop_maxpenalty = "Niedrigere Besitzbonus-Grenze"
L.label_spec_prop_maxbonus = "Höhere Besitzbonus-Grenze"
L.label_spec_prop_force = "Besitz Stoßkraft"
L.label_spec_prop_rechargetime = "Aufladzeit in Sekunden"
L.label_doors_force_pairs = "Zwinge nahestehende Türen zu Doppeltüren"
...
L.label_doors_health = "Türleben"
L.label_doors_prop_health = "Zerstörte-Türleben"
...
L.label_karma_starting = "Start Karma"
...
L.label_karma_traitorkill_bonus = "Bonusverhältnis für das Töten von Feinden"
...
L.label_karma_low_ban_minutes = "Ban Zeit in Minuten"
...
L.label_max_carry_slots = "Maximale Trag Slots"
L.label_max_unarmed_slots = "Maximale Unbewaffnet Slots"
...
L.hudeditor_chat_hint1 = "[TTT2][INFO] Fahren Sie mit der Maus über ein Element, drücken und halten Sie [LMB] und bewegen Sie die Maus, um es zu VERSCHIEBEN oder zu VERGRÖßERN."
L.hudeditor_chat_hint2 = "[TTT2][INFO] Halten Sie die ALT-Taste gedrückt, um eine symmetrische Vergrößerung/Verkleinerung durchzuführen."
L.hudeditor_chat_hint3 = "[TTT2][INFO] Halten Sie die UMSCHALT-Taste gedrückt, um auf der Achse zu bewegen und das Seitenverhältnis beizubehalten."
...
L.slot_weapon_carry = "Tragen Slot"
