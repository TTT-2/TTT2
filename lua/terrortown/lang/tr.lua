...
L.search_floor_plastic = "'Ah, bu acıtmış olmalı.' Ceseti yanıklarla kaplı. Plastik bir yüzey üzerinde kayarken meydana gelenlere benziyor."
...
L.search_floor_sand = "Küçük küçük pürüzlü taşlar soğuk cesetine yapışmış. Kumsaldaki kaba kum gibi. Ahh, her yere bulaşıyor!"
L.search_floor_foliage = "Doğa harikadır. Kurbanın kanlı yaraları, neredeyse gizlenecek kadar yeşilliklerle kaplı."
L.search_floor_computer = "Bip-bup. Ceseti bilgisayar yüzeyiyle kaplı! Bu nasıl görünüyor diye sorabilirsiniz. Ee, yani!"
...
L.search_floor_glass = "Ceseti birçok kanlı kesikle kaplı. Bazılarında cam kırıkları sıkışmış ve size oldukça tehditkâr görünüyor."
