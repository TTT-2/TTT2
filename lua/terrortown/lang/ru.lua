...
-- Various other text
L.name_kick = "Игрок был автоматически выгнан за смену имени во время раунда."
...
L.radio_help_primary = "Разместить Радио"
L.radio_help_secondary = "Прикрепить к поверхности"
L.hstation_help_primary = "Разместить Лечебную станцию"
