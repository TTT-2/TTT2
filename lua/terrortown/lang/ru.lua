...
L.header_voicechat_locational = "Локальный голосовой чат"
...
L.help_killer_dna_range = "Когда один игрок умирает от рук другого, на теле остаётся образец ДНК. Настройка ниже определяет максимальную дальность в юнитах Hammer для оставления образцов ДНК. Если убийца будет находиться дальше этого значения в момент смерти жертвы, то на теле не останется образца."
...
Изменением имени во время активного раунда можно злоупотребить во избежание убийства. Поэтому изменять его запрещено по умолчанию.
...
Голосовое общение при включённой батарее голосового чата снижает её заряд. Когда он пуст, игрок не может использовать голосовой чат и должен подождать несколько секунд для подзарядки. Это может помочь предотвратить чрезмерное использование голосового чата.
...
L.label_radar_charge_time = "Время перезарядки после образца радара"
...
L.label_locational_voice = "Включить локальный трёхмерный звук для живых игроков"
...
L.label_announce_body_found = "Объявлять о нахождении тел"
L.label_confirm_killlist = "Объявлять список убитых с подтверждённых тел"
L.label_inspect_detective_only = "Ограничить осмотр тел только полицейским ролям"
L.label_confirm_detective_only = "Ограничить подтверждение тел только полицейским ролям"
