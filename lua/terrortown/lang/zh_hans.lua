...
L.search_floor_antlions = "身上仍然到处都是蚁龙。地板上一定布满了它们。"
...
L.search_floor_grate = "受害者的皮肤看起来像牛排。整个人都能看到排列成网格的粗线。他们是不是躺在格栅上？"
L.search_floor_alienflesh = "外星人的肉，你认为？听起来有点离奇。但你的侦探助手书将其列为可能的地面表面。"
L.search_floor_snow = "一眼看去，他们的衣服只是湿的，冰冷的。但当你看到边缘的白色泡沫时，你就明白了。那是雪！"
L.search_floor_plastic = "'哎哟，那一定很疼。'他们的身体被烧伤。看起来像是在塑料表面滑动时得到的那种。"
...
L.search_floor_computer = "嘀嗒嘀嗒。他们的身体被计算机表面覆盖！这看起来是什么样子，你可能会问？嗯，嘿嘿！"
...
L.search_hitgroup_head = "弹头在他们的头部找到。"
