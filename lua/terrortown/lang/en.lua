...
-- 2021-10-08
L.roleinfo_belong_innoccent = "You belong to the Innocents!"
L.roleinfo_belong_traitor = "You belong to the Traitors!"
L.roleinfo_belong_none = "You belong to none! You are and fight alone!"
L.roleinfo_text_innocent = "You have no special abilities. Find the evil ones among the terrorists and kill them."
L.roleinfo_text_traitor = "You'll have a menu with which you'll be able to buy special equipment. Kill all enemies."
L.roleinfo_text_detective = "You are the one whom the Innocents can trust. But who is innocent? Find all the evil terrorists, using the equipment in your shop."