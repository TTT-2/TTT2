-- British language strings

local L = LANG.CreateLanguage("en_gb")
...
L.item_armor = "Body Armour"
L.item_armor_desc = [[
Reduces bullet, fire and explosion damage. Depletes over time.

It can be purchased multiple times. After reaching a specific armour value, the armour becomes stronger.]]
...
-- Visualiser
L.vis_name = "Visualiser"

L.vis_desc = [[
Crime scene visualisation device.

Analyses a corpse to show how the victim was killed, but only if they died of gunshot wounds.]]
...
L.punch_bonus = "Your bad score lowered your punch-o-metre limit by {num}"
L.punch_malus = "Your good score increased your punch-o-metre limit by {num}!"
...
L.aw_exp1_text = "was recognised for their research on explosions. {num} test subjects helped out."
...
L.aw_pst2_title = "Small Calibre Slaughter"
...
-- 2019-05-06
L.equip_not_alive = "You can view all available items by selecting a role on the right. Don't forget to mark your favourites!"
...
-- 2019-11-03
L.vis_short_desc = "Visualises a crime scene if the victim died by a gunshot wound"
...
L.help_color_desc = "If this setting is enabled, you can choose a global colour that will be used for the targetID outline and the crosshair."
...
L.help_vskin_info = "VSkin (VGUI skin) is the skin applied to all menu elements like the current one. They can be easily created with a simple Lua script and can change colours and some size parameters."
L.help_targetid_info = "TargetID is the information rendered when pointing your crosshair at an entity. Its colour can be configured in the 'General' tab."
...
L.label_global_color_enable = "Enable global colour"
L.label_global_color = "Global colour"
...
L.label_color_enable = "Enable VSkin background colour"
...
L.label_hud_basecolor = "Base Colour"
...
L.header_global_color = "Select Global Colour"
L.header_hud_select = "Select a HUD"
L.header_hud_customize = "Customise the HUD"
L.header_vskin_select = "Select and Customise the VSkin"
...
-- 2020-04-30
L.message_revival_canceled = "Revival cancelled."
...
L.desc_event_kill_club_using = "{victim} ({vrole} / {vteam}) was pummelled to death by {attacker} ({arole} / {ateam}) using {trap}."
...
L.desc_event_kill_tele_using = "{victim} ({vrole} / {vteam}) was atomised by {trap} set by {attacker} ({arole} / {ateam})."
...
L.shopeditor_desc_random_shops = [[Random shops give every player a limited randomised set of all available equipments.
Team shops forcefully give the same set to all players in a team instead of individual ones.
Rerolling allows you to get a new randomised set of equipment for credits.]]
...
L.header_playersettings_armor = "Armour System Settings"
...
L.help_armor_balancing = "The following values can be used to balance the armour."
L.help_item_armor_classic = "If classic armour mode is enabled, only the previous settings matter. Classic armour mode means that a player can only buy armour once in a round, and that this armour blocks 30% of the incoming bullet and crowbar damage until they die."
L.help_item_armor_dynamic = [[
Dynamic armour is the TTT2 approach to make armour more interesting. The amount of armour that can be bought is now unlimited, and the armour value stacks. Getting damaged decreases the armour value. The armour value per bought armour item is set in the 'Equipment Settings' of said item.

When taking damage, a certain percentage of this damage is converted into armour damage, a different percentage is still applied to the player and the rest vanishes.

If reinforced armour is enabled, the damage applied to the player is decreased by 15% as long as the armour value is above the reinforcement threshold.]]
...
The maximum value of the 'punch-o-meter' consists of a possession base value, where the kills/deaths difference clamped inbetween two defined limits is added. The metre slowly recharges over time. The set recharge time is the time needed to recharge a single point in the 'punch-o-meter'.]]
L.help_karma = "Players start with a certain amount of Karma, and lose it when they damage/kill teammates. The amount they lose is dependant on the Karma of the person they hurt or killed. Lower Karma reduces damage given."
...
L.help_item_armor_value = "This is the armour value given by the armour item in dynamic mode. If classic mode is enabled (see 'Administration' -> 'Player Settings') then every value greater than 0 is counted as existing armour."
...
L.label_armor_on_spawn = "Player armour on (re-)spawn"
...
L.label_armor_block_headshots = "Enable armour blocking headshots"
L.label_armor_block_blastdmg = "Enable armour blocking blast damage"
L.label_armor_dynamic = "Enable dynamic armour"
L.label_armor_value = "Amount of armour given by the armour item"
L.label_armor_damage_block_pct = "Damage percentage taken by armour"
L.label_armor_damage_health_pct = "Damage percentage taken by player"
L.label_armor_enable_reinforced = "Enable reinforced armour"
L.label_armor_threshold_for_reinforced = "Reinforced armour threshold"
...
L.search_armor = "They were wearing nonstandard body armour."
...
L.search_floor_concrete = "Grey dust covers their shoes and knees. Looks as if the crime scene had a concrete floor."
...
L.header_hud_elements_customize = "Customise the HUD-Elements"
...
-- 2023-10-26
L.item_armor_reinforced = "Reinforced Armour"
L.item_armor_sidebar = "Armour protects you against bullets penetrating your body. But not forever."
...
-- 2023-12-13
L.vis_no_pickup = "Only public policing roles can pick up the visualiser"
...
L.help_enable_dynamic_fov = "Dynamic FOV is applied depending on the player's speed. When a player is sprinting for example, the FOV is increased to visualise the speed."
...
L.label_crosshair_outline_high_contrast = "Enable outline high contrast colour"
...
L.header_commands_player_set_armor = "Set Armour"
